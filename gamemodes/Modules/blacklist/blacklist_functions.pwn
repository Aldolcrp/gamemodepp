...
ShowDurringBlacklist(playerid, targetid)
{
    ...
    \n\n"GRAY"- [Kepolisian Daerah Astral City] -\
    \nStatus: "YELLOW"%s\
    \n"GRAY"Petugas: %s\
    \nAlasan: %s\
    \n\n- [Pemerintah Daerah Astral City] -\
    \nStatus: "YELLOW"%s\
    \n"GRAY"Petugas: %s\
    \nAlasan: %s\
    ...
    \n"GRAY"Petugas: %s\
    \nAlasan: %s\
    \n\n- [Bengkel Kota Astral City]-\
    \nStatus: "YELLOW"%s\
    \n"GRAY"Petugas: %s\
    \nAlasan: %s\
    \n\n- [Pedagang Kota Astral City] -\
    \nStatus: "YELLOW"%s\
    \n"GRAY"Petugas: %s\
    \nAlasan: %s", 
    ReturnName(targetid),
    ...
    ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Cek Blacklist", strgbg, "Tutup", "");
    return 1;
}
