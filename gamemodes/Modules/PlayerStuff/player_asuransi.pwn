...
hook OnGameModeInit()
{
	CreateDynamic3DTextLabel(""GREEN"[Y]"WHITE"- Asuransi Kendaraan", -1, 1090.589, -1792.728, 13.678 + 0.3, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1);// LS
	...
	CreateDynamicPickup(1080, 23, 1097.565, -1769.497, 13.333 + 0.2, 0, 0, -1, 15.0);
	CreateDynamic3DTextLabel(""RED"[Peringatan]\n"WHITE"Dilarang parkir di area ini, ini adalah area spawn asuransi", -1, 1097.565, -1769.497, 13.333 + 0.8, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1);
...
hook OnPlayerKeyStateChange(playerid, newkeys, oldkeys)
{
	...
	{
		if(IsPlayerInRangeOfPoint(playerid, 1.5, 1090.589, -1792.728, 13.678))
		{
...
hook OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
	if(dialogid == DIALOG_ASURANSI_LS)
	{
		...
		if(!IsPlayerInRangeOfPoint(playerid, 2.5, 1090.589, -1792.728, 13.678)) return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda tidak di titik asuransi!");
		...
		PlayerVehicle[iter][pVehPos][0] = 1097.565;
		PlayerVehicle[iter][pVehPos][1] = -1769.497;
		PlayerVehicle[iter][pVehPos][2] = 13.333;
		PlayerVehicle[iter][pVehPos][3] = 199.530;
