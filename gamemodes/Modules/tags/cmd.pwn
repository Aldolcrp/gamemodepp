CMD:tag(playerid, params[])
{
	...
	else if (!strcmp(options, "clean", true))
	{
		...
		{
			if((AccountData[playerid][pFaction] != FACTION_POLISI) && (AccountData[playerid][pFaction] != FACTION_PEMERINTAH) && (TagsData[index][tagPlayerID] != AccountData[playerid][pID]) && (GetAdminLevel(playerid) < 5))
