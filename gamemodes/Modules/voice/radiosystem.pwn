...
hook ClickDynPlayerTextdraw(playerid, PlayerText: playertextid)
{
    ...
    {   
        ShowPlayerDialog(playerid, DIALOG_RADIO_FREQ, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Radio Fx",
...
hook OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
    switch(dialogid)
    {
        case DIALOG_RADIO_FREQ:
        {
            ...
            if(isnull(inputtext)) return ShowPlayerDialog(playerid, DIALOG_RADIO_FREQ, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Radio Fx",
            "Error: Tidak dapat diisi kosong!\nMasukkan frekuensi radio yang ingin diterapkan pada kolom dibawah ini\
            \n(Frekuensi harus berada diantara 0 - 9999)\
            \nCatatan: Masukkan frekuensi 0 untuk memutuskan saluran frekuensi/netral", "Submit", "Batal");

            if(!IsNumeric(inputtext)) return ShowPlayerDialog(playerid, DIALOG_RADIO_FREQ, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Radio Fx",
            "Error: Hanya dapat diisi angka!\nMasukkan frekuensi radio yang ingin diterapkan pada kolom dibawah ini\
            \n(Frekuensi harus berada diantara 0 - 9999)\
            \nCatatan: Masukkan frekuensi 0 untuk memutuskan saluran frekuensi/netral", "Submit", "Batal");

            if(strval(inputtext) < 0 || strval(inputtext) > 9999) return ShowPlayerDialog(playerid, DIALOG_RADIO_FREQ, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Radio Fx",
            ...
            {
                if(AccountData[playerid][pFaction] != FACTION_POLISI && AccountData[playerid][pFaction] != FACTION_EMS) return ShowTDN(playerid, NOTIFICATION_ERROR, "Freq 1 khusus Polisi tetapi dapat dimasuki EMS!");
            ...
            {
                if(AccountData[playerid][pFaction] != FACTION_POLISI && AccountData[playerid][pFaction] != FACTION_EMS) return ShowTDN(playerid, NOTIFICATION_ERROR, "Freq 2 khusus EMS tetapi dapat dimasuki Polisi!");
            ...
            {
                if(AccountData[playerid][pFaction] != FACTION_PEMERINTAH) return ShowTDN(playerid, NOTIFICATION_ERROR, "Freq 3 khusus Instansi Pemerntah Astral City!");
            ...
            {
                if(AccountData[playerid][pFaction] != FACTION_POLISI && AccountData[playerid][pFaction] != FACTION_EMS && AccountData[playerid][pFaction] != FACTION_TRANS) return ShowTDN(playerid, NOTIFICATION_ERROR, "Freq 4 khusus Transportasi tetapi dapat dimasuki Polisi dan EMS!");
            ...
            {
                if(AccountData[playerid][pFaction] != FACTION_POLISI && AccountData[playerid][pFaction] != FACTION_EMS && AccountData[playerid][pFaction] != FACTION_BENGKEL) return ShowTDN(playerid, NOTIFICATION_ERROR, "Freq 5 khusus Bengkel tetapi dapat dimasuki Polisi dan EMS!");
            ...
            {
                if(AccountData[playerid][pFaction] != FACTION_POLISI && AccountData[playerid][pFaction] != FACTION_EMS && AccountData[playerid][pFaction] != FACTION_PEDAGANG) return ShowTDN(playerid, NOTIFICATION_ERROR, "Freq 6 khusus Pedagang tetapi dapat dimasuki Polisi dan EMS!");
            ...
            {
                if(AccountData[playerid][pFaction] != FACTION_POLISI && AccountData[playerid][pFaction] != FACTION_EMS) return ShowTDN(playerid, NOTIFICATION_ERROR, "Freq khusus Saluran Gabungan Polisi dan EMS!");
...
CMD:sv(playerid, params[])
{
    ...
    ShowPlayerDialog(playerid, DIALOG_VOICEMODE, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Voice Range",
    ""RED"Teriak\
    \nNormal\
...
CMD:vkeys(playerid, params[])
{
    ...
    ShowPlayerDialog(playerid, DIALOG_VOICEKEYS, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Voice Keybind",
    "Keybind: B (Default)\
    \n"GRAY"Keybind: R\
    \nKeybind: X\
    \n"GRAY"Keybind: Z\
