...
#define COLOR_PINK			0x0080FFFF
#define COLOR_PINK2		 	0x0080FFFF
...
#define ASTRALCITY_YELLOW		0xFFFF00FF
...
#define ASTRALCITY		"{ffff00}"
#define VTWITTER	"{0599fb}"
#define ASTRALCITYDOT	"{FFFF00}[!] {FFFFFF}"
#define ASTRALCITY_ORANGE "{FFA000}"
#define ASTRALCITY_G	"{72D172}"
#define ASTRALCITY_GREEN		"{00ff00}"
#define ASTRALCITY_ARWIN "{BEBEBE}"
#define ASTRALCITY_PURPLE "{DE76D5}"
#define ASTRALCITY_IJMUD "{76D172}"
#define ASTRALCITY_PASTEL "{EBB064}"
#define ASTRALCITY_OCEAN  "{67A3D9}"
#define ASTRALCITY_MPURPLE "{8767D9}"
#define ASTRALCITY_X11PLUM1 "{FFBBFF}"
