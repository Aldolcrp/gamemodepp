...
function TDWEBACCOUNT(playerid)
{
	...
	CreateTextdrawAnimation(playerid, NamaServer[playerid][0], 150, "", "ASTRALCITYAROLEPLAY.ID");
...
function TDNAMASERVER(playerid)
{
	PlayerTextDrawHide(playerid, NamaServer[playerid][0]);
	PlayerTextDrawShow(playerid, NamaServer[playerid][0]);
	CreateTextdrawAnimation(playerid, NamaServer[playerid][0], 150, "", "ASTRALCITYROLEPLAY.ID");
...
{
    NamaServer[playerid][0] = CreatePlayerTextDraw(playerid, 491.000, 8.000, "ASTRALCITYROLEPLAY.ID");
