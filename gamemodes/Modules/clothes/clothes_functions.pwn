...
ShowPlayerClothes(playerid)
{
    ...
    if(rows)
    {
        ...
        ShowPlayerDialog(playerid, DIALOG_CLOTHES, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Lemari Pakaian", list, "Pilih", "Batal");
    }
    else 
    {
        PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
        ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Lemari Pakaian", 
...
DropClothesPlayer(playerid)
{
    ...
    if(cache_num_rows())
    {
        ...
        ShowPlayerDialog(playerid, DIALOG_CLOTHES_DELETE, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Buang Pakaian", list, "Buang", "Batal");
    }
    else 
    {
