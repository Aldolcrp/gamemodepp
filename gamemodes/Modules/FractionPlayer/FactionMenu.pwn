...
ShowFactionMenu(playerid)
{
    if (AccountData[playerid][pFaction] == FACTION_POLISI)
    {
        ...
        ShowPlayerDialog(playerid, DIALOG_POLICE_PANEL, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Faction Panel (Polisi)", sha, "Pilih", "Batal");
    }
    ...
    if (AccountData[playerid][pFaction] == FACTION_PEMERINTAH)
    {
        ...
        strcat(sha, ""GRAY"Cek blacklist\n");
        ShowPlayerDialog(playerid, DIALOG_PEMERINTAH_PANEL, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Faction Panel (PEMER)", sha, "Pilih", "Batal");
    }
    ...
    if (AccountData[playerid][pFaction] == FACTION_EMS)
    {
        ...
        ShowPlayerDialog(playerid, DIALOG_EMS_PANEL, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Faction Panel (EMS)", str, "Pilih", "Batal");
    }
    ...
    if (AccountData[playerid][pFaction] == FACTION_BENGKEL)
    {
        ...
        ShowPlayerDialog(playerid, DIALOG_BENGKEL_PANEL, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Faction Panel (Bennys)", str, "Pilih", "Batal");
    }
    ...
    if (AccountData[playerid][pFaction] == FACTION_PEDAGANG)
    {
        ...
        strcat(str, ""WHITE"Invoice manual\n");
        strcat(str, ""GRAY"Cek blacklist\n");
        Dialog_Show(playerid, DIALOG_PEDAGANG_PANEL, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Faction Panel (Pedagang)", str, "Pilih", "Batal");
    }
    ...
    if (AccountData[playerid][pFamily] != -1)
    {
        ...
        ShowPlayerDialog(playerid, DIALOG_FAMILY_PANEL, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE" - Faction Menu (Gang)", str, "Pilih", "Batal");
    }
    return 1;
}
...
Dialog:PANEL_NONE(playerid, response, listitem, inputtext[])
{
    ...
    if (count != 0) {
        if (GetPVarInt(playerid, "OnCarry") && IsDragging[playerid] != INVALID_PLAYER_ID)
        {
            ...
            Dialog_Show(playerid, PANEL_DRAG, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Drag/Undrag Person", frmtx, "Pilih", "Batal");
    } 
...
Dialog:PANEL_DRAG(playerid, response, listitem, inputtext[])
{
    ...
    if (!GetPVarInt(playerid, "OnCarry") && IsDragging[playerid] == INVALID_PLAYER_ID)
    {
        Dialog_Show(targetid, PANEL_DRAGCONF, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Drag/Undrag Person",
