...
VarsDoorPolice()
{
    PoliceStuff[PoldaDuty] = CreateDynamicSphere(1778.210, -1782.465, 14.105, 2.0, 0, 0, -1);
    PoliceStuff[PoldaDesk] = CreateDynamicSphere(1779.181, -1788.921, 14.106, 2.0, 0, 0, -1);
    PoliceStuff[PoldaGun] = CreateDynamicSphere(1774.397, -1778.886, 18.921, 2.0, 0, 0, -1);
    PoliceStuff[PoldaBrankas] = CreateDynamicSphere(1770.871, -1778.630, 18.921, 2.0, 0, 0, -1);
    PoliceStuff[PoldaLocker] = CreateDynamicSphere(1771.038, -1772.331, 18.922, 2.0, 0, 0, -1);
    PoliceStuff[PoldaGarage] = CreateDynamicSphere(1751.398, -1787.167, 13.599, 2.0, 0, 0, -1);
    PoliceStuff[PoldaImpound] = CreateDynamicSphere(1749.673, -1768.585, 13.609, 2.0, 0, 0, -1);
    PoliceStuff[PoldaHelipad] = CreateDynamicSphere(1777.045, -1776.630, 24.602, 2.0, 0, 0, -1);
    ...
    PoliceStuff[PoldaGaragePOS][0] = 1751.398;
    PoliceStuff[PoldaGaragePOS][1] = -1787.167;
    PoliceStuff[PoldaGaragePOS][2] = 13.599;
    PoliceStuff[PoldaSpawnPOS][0] = 1760.406;
    PoliceStuff[PoldaSpawnPOS][1] = -1782.246;
    PoliceStuff[PoldaSpawnPOS][2] = 13.598;
    PoliceStuff[PoldaSpawnPOS][3] = 2.128;
...
stock Sapd_GedelahFiture(playerid, targetid)
{
    ...
    Dialog_Show(playerid, SapdGeledah, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Geledah", str, "Pilih", "Batal");
    return 1;
}

Dialog:SapdGeledah(playerid, response, listitem, inputtext[])
{
    if(AccountData[playerid][pFaction] != FACTION_POLISI) return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan bagian dari Kepolisian Kota Astral City!");
    if(response)
    {
        ...
        if(InventoryData[targetid][listitem][invExists])
        {
            ...
            Dialog_Show(playerid, SapdTakeBarang, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Geledah", str, "Input", "Batal");
        }
    }
    return 1;
}
...
hook OnPlayerKeyStateChange(playerid, newkeys, oldkeys)
{
    if(newkeys & KEY_YES && GetPlayerState(playerid) == PLAYER_STATE_ONFOOT)
    {
        if(AccountData[playerid][pFaction] == FACTION_POLISI)
        {
            ...
            {
                ShowPlayerDialog(playerid, DIALOG_POLICE_IMPOUND, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Impound",
                "Masukkan ID Pemain yang ingin dicek kendaraannya", "Submit", "Batal");
                // Dialog_Show(playerid, DialogCekPlayerImpound, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Impound", 
            ...
            {
                Dialog_Show(playerid, DialogLockerSapd, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Pakaian", 
                "Baju Biasa\
            ...
            if(IsPlayerInRangeOfPoint(playerid, 2.5, 1751.398, -1787.167, 13.599) && AccountData[playerid][pDutyPD]) // Polda Garage
            {
                ShowPlayerDialog(playerid, DIALOG_POLICE_GARAGE, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Garasi Polda", 
            ...
            {
                ShowPlayerDialog(playerid, DIALOG_FEDERAL_GARAGE, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Garasi Federal", 
                "Keluarkan Kendaraan\ 
                \n"GRAY"Simpan Kendaraan\ 
                \nBeli Kendaraan\ 
                \n"GRAY"Hapus Kendaraan", "Pilih", "Batal");
            ...
            if(IsPlayerInRangeOfPoint(playerid, 2.5, 1777.045, -1776.630, 24.602) && AccountData[playerid][pDutyPD]) // Helipad
            {
                ShowPlayerDialog(playerid, DIALOG_POLICE_HELI_GARAGE, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Garasi Polda",
                "Keluarkan Kendaraan\
                \n"GRAY"Simpan Kendaraan\
                \nBeli Kendaraan\
                \n"GRAY"Hapus Kendaraan", "Pilih", "Batal");
            ...
            {   
                ...
                Dialog_Show(playerid, BrankasPolice, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Brankas Kepolisian", "Beli Senjata", "Pilih", "Batal");
            }
            ...
            if(IsPlayerInDynamicArea(playerid, PoliceStuff[PoldaDesk]))
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_POLICE_BOSDESK, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Bos Desk", 
                "Invite\
                \n"GRAY"Kelola Jabatan\
                \nKick\
            ...
            if(IsPlayerInDynamicArea(playerid, PoliceStuff[PoldaBrankas]) && AccountData[playerid][pDutyPD])
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_POLVAULT, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Brankas Polisi", 
...
hook OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
    if(dialogid == DIALOG_POLICE_PANEL)
    {
        ...
        if(AccountData[playerid][pFaction] != FACTION_POLISI) return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan bagian dari anggota Kepolisian Astral City");
        new targetid = AccountData[playerid][pTarget];
        ...
        switch(listitem)
        {
            ...
            case 4: // Borgol
            {
                ...
                AccountData[targetid][pFreeze] = true;
            ...
            case 5: // Lepas Borgol
            {
                if(AccountData[targetid][pCuffed] == 1)
                {
                    ...
                    AccountData[targetid][pFreeze] = false;
            ...
            case 11:// Penjarakan
            {
                ...
                Dialog_Show(playerid, Dialog_PenjaraFederal, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Penjarakan", "Masukan jumlah menit yang ingin diberikan:", "Input", "Batal");
            }
            ...
            case 19: // Buat Catatan Kriminal
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_ADD_HKRIMINAL, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Buat Catatan Kriminal",
            ...
            {
                SetPVarInt(playerid, "IDTarget", targetid);
                ShowPlayerDialog(playerid, DIALOG_REMOVE_HKRIMINAL, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Hapus Catatan Kriminal",
    ...
    else if(dialogid == DIALOG_REMOVE_HKRIMINAL)
    {
        ...
        if(AccountData[playerid][pFaction] != FACTION_POLISI) return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan bagian dari Kepolisian Astral City!");
    ...
    else if(dialogid == DIALOG_ADD_HKRIMINAL)
    {
        ...
        if(isnull(inputtext)) return ShowPlayerDialog(playerid, DIALOG_ADD_HKRIMINAL, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Buat Catatan Kriminal",
        "Error: Tidak dapat diisi kosong!\nMohon masukkan deskripsi catatan kriminal yang akan diberikan kepada orang tersebut dibawah ini:", "Buat", "Batal");

        if(IsNumeric(inputtext)) return ShowPlayerDialog(playerid, DIALOG_ADD_HKRIMINAL, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Buat Catatan Kriminal",
        "Error: Tidak dapat diisi angka!\nMohon masukkan deskripsi catatan kriminal yang akan diberikan kepada orang tersebut dibawah ini:", "Buat", "Batal");

        if(strlen(inputtext) > 128) return ShowPlayerDialog(playerid, DIALOG_ADD_HKRIMINAL, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Buat Catatan Kriminal",
        ...
        switch(listitem)
        {
            case 0:// Invite
            {
                ...
                if(count == 0)
                {
                    ...
                    return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Invite",
                    "Tidak ada orang di sekitar anda!", "Tutup", "");
                }

                ShowPlayerDialog(playerid, DIALOG_POLICE_INVITE, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Invite", frmxt, "Pilih", "Batal");
            }
            case 1:// Kelola Jabatan:
            {
                ...
                if(rows)
                {
                    ...
                    ShowPlayerDialog(playerid, DIALOG_POLICESETRANK, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Set Jabatan", shstr, "Pilih", "Batal");
                    // ShowPlayerDialogPages(playerid, "PolisiSetRank", DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Set Jabatan", "Pilih", "Batal", 15, ""GREEN">> Lanjut", ""ORANGE"<< Kembali");
                }
                else 
                {
                    PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
                    return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Set Jabatan", "Tidak ada Anggota Polisi!", "Tutup", "");
                }
            }
            case 2://
            {
                ...
                if(rows)
                {
                    ...
                    ShowPlayerDialog(playerid, DIALOG_POLICEKICKMEMBER, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Set Jabatan", shstr, "Kick", "Batal");
                    // ShowPlayerDialogPages(playerid, "PolisiKickMember", DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Set Jabatan", "Kick", "Batal", 15, ""GREEN">> Lanjut", ""ORANGE"<< Kembali");
                }
                else 
                {
                    PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
                    return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Set Jabatan", "Tidak ada Anggota Kepolisian!", "Tutup", "");
                }
            }
            case 3:// Saldo Finansial
            {
                new frmxt[255];
                format(frmxt, sizeof(frmxt), "Perusahaan Kepolisian Astral City saat ini memiliki saldo sebesar:\
                \n"DARKGREEN"%s", FormatMoney(PoliceMoneyVault));
                ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Police Money", frmxt, "Tutup", "");
            }
            case 4:// Depo Saldo 
            {
                ShowPlayerDialog(playerid, DIALOG_DEPOSIT_POLICE, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Polisi Deposit",
                "Mohon masukkan nominal deposit untuk saldo perusahaan:", "Input", "Batal");
            }
            case 5:// Withdraw Saldo
            {
                ShowPlayerDialog(playerid, DIALOG_WITHDRAW_POLICE, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Polisi Withdraw", 
    ...
    else if(dialogid == DIALOG_POLICESETRANK)
    {
        ...
        if(AccountData[playerid][pFaction] != FACTION_POLISI) return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan anggota Polda Astral City!");
        ...
        if(rows)
        {
            ...
            ShowPlayerDialog(playerid, DIALOG_RANK_SET_POLISI, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Kelola Jabatan", \
        ...
        if(cache_num_rows())
        {
            ...
            foreach(new i : Player)
            {
                if(AccountData[i][IsLoggedIn] && AccountData[i][pSpawned] && pidrow == AccountData[i][pID])
                {
                    ...
                    RefreshFactionMap(i);
                    ShowTDN(i, NOTIFICATION_WARNING, "Anda telah dikeluarkan dari faction Kepolisian Astral City!");
                }
            }
            ...
            ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Kick Anggota",
            kckstr, "Tutup", "");
    ...
    else if(dialogid == DIALOG_RANK_SET_POLISI)
    {
        ...
        if(isnull(inputtext)) return ShowPlayerDialog(playerid, DIALOG_RANK_SET_POLISI, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Kelola Jabatan", \
        "Error: Tidak dapat diisi kosong!\
        \nSilahkan pilih jabatan untuk ditetapkan (masukkan angka saja):\
        \n1. BRIPDA\
        \n2. BRIPTU\
        ...
        if(!IsNumeric(inputtext)) return ShowPlayerDialog(playerid, DIALOG_RANK_SET_POLISI, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Kelola Jabatan", \
        ...
        if(strval(inputtext) < 1 || strval(inputtext) > AccountData[playerid][pFactionRank]) return ShowPlayerDialog(playerid, DIALOG_RANK_SET_POLISI, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Kelola Jabatan", \
    ...
    else if(dialogid == DIALOG_DEPOSIT_POLICE)
    {
        ...
        ShowTDN(playerid, NOTIFICATION_SUKSES, sprintf("Anda berhasil deposit %s untuk Kepolisian Astral City", FormatMoney(depocash)));
    }
    else if(dialogid == DIALOG_WITHDRAW_POLICE)
    {
        ...
        ShowTDN(playerid, NOTIFICATION_SUKSES, sprintf("Anda berhasil withdraw %s dari Kepolisian Astral City", FormatMoney(withdrawcash)));
    }
        ...
        switch(listitem)
        {
            case 0: //deposit
            {
                ...
                if(rows)
                {
                    ...
                    ShowPlayerDialog(playerid, DIALOG_POLVAULT_DEPOSIT, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Brankas Polisi", str, "Pilih", "Batal");
                }
                else 
                {
                    AccountData[playerid][menuShowed] = false;
                    PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
                    return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Brankas Polisi",
            ...
            case 1: //withdraw
            {
                ...
                if(cache_num_rows() > 0)
                {
                    ...
                    ShowPlayerDialog(playerid, DIALOG_POLVAULT_WITHDRAW, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Brankas Polisi", str, "Pilih", "Batal");
                }
                else 
                {
                    AccountData[playerid][menuShowed] = false;
    ...
    else if(dialogid == DIALOG_POLVAULT_DEPOSIT)
    {
        ...
        if(cache_num_rows() > 0)
        {
            ...
            ShowPlayerDialog(playerid, DIALOG_POLVAULT_IN, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas Polisi", 
            shstr, "Input", "Batal");
        }
    }
    else if(dialogid == DIALOG_POLVAULT_IN)
    {
        if(PolisiProcessing[playerid])
            return ShowTDN(playerid, NOTIFICATION_WARNING, "Sedang memproses permintaan, tunggu sebentar!");
        PolisiProcessing[playerid] = true;

        if(!response)
        {
            PolisiProcessing[playerid] = false;
            AccountData[playerid][menuShowed] = false;
            return ShowTDN(playerid, NOTIFICATION_INFO, "Anda telah membatalkan pilihan");
        }
        ...
        if(isnull(inputtext) || !IsNumeric(inputtext))
        {
            ...
            format(shstr, sizeof(shstr), "Anda akan menyimpan item:\nNama: %s\nJumlah di tas: %d\nMohon masukkan jumlah valid!",
                FactionBrankas[playerid][factionBrankasTemp], FactionBrankas[playerid][factionBrankasQuant]);
            ShowPlayerDialog(playerid, DIALOG_POLVAULT_IN, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas Polisi", shstr, "Input", "Batal");
            PolisiProcessing[playerid] = false;
            return 1;
        }
        ...
        // CEK INVENTORY TERBARU
        new avail = Inventory_Count(playerid, FactionBrankas[playerid][factionBrankasTemp]);
        if(avail <= 0)
        {
            PolisiProcessing[playerid] = false;
        ...
        if(requested > avail) requested = avail; // batasi jumlah sesuai inventory

        Inventory_Remove(playerid, FactionBrankas[playerid][factionBrankasTemp], requested);
        ShowItemBox(playerid, sprintf("Removed %dx", requested), FactionBrankas[playerid][factionBrankasTemp], FactionBrankas[playerid][factionBrankasModel]);

        static frmtx[178];
        format(frmtx, sizeof(frmtx), "POLISI - Menyimpan %s dengan Jumlah %d", FactionBrankas[playerid][factionBrankasTemp], requested);
        AddFMoneyLog(AccountData[playerid][pName], AccountData[playerid][pUCP], requested, frmtx);
        ...
        if(rows > 0)
        {
            mysql_format(g_SQL, invstr, sizeof(invstr), "UPDATE `polisi_brankas` SET `Quantity` = `Quantity` + %d WHERE `PID`=0 AND `Item`='%s'",
                requested, FactionBrankas[playerid][factionBrankasTemp]);
            mysql_tquery(g_SQL, invstr, "OnPolisiDeposit", "i", playerid);
        }
        else 
        {
            mysql_format(g_SQL, invstr, sizeof(invstr), "INSERT INTO `polisi_brankas` SET `PID`=0, `Item`='%s', `Model`=%d, `Quantity`=%d",
                FactionBrankas[playerid][factionBrankasTemp], FactionBrankas[playerid][factionBrankasModel], requested);
            mysql_tquery(g_SQL, invstr, "OnPolisiDeposit", "i", playerid);
        }
    ...
    else if(dialogid == DIALOG_POLVAULT_WITHDRAW)
    {
        ...
        if(cache_num_rows() > 0)
        {
            ...
            ShowPlayerDialog(playerid, DIALOG_POLVAULT_OUT, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas Polisi",
            shstr, "Input", "Batal");
        }
        else 
        {
            AccountData[playerid][menuShowed] = false;
            ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Brankas Polisi",
    ...
    else if(dialogid == DIALOG_POLICE_HELI_GARAGE)
    {
        ...
        switch(listitem)
        {
            case 0:// Keluarkan Kendaraan
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_POLICE_HELI_GARAGE_OUT, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Garasi Polda", list, "Pilih", "Batal");
            }
            case 1:// Simpan Kendaraan
            {
                ...
                if(!foundnearby) return ShowTDN(playerid, NOTIFICATION_ERROR, "Tidak ada kendaraan dari Kepolisian Astral City milik anda di sekitar!");
            }
            case 2:// Beli Kendaraan
            {
                ShowPlayerDialog(playerid, DIALOG_POLICE_HELI_BUY, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Garasi Polda",
                "Model\tHarga\ 
            ...
            case 3:// Hapus Kendaraan
            {
                ...
                if(rows)
                {
                    ...
                    ShowPlayerDialog(playerid, DIALOG_POLICE_GARAGE_DEL, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Hapus Kendaraan", list, "Hapus", "Batal");
                }
                else 
                {
                    PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
                    return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Hapus Kendaraan", "Anda tidak memiliki kendaraan Polisi!", "Tutup", "");
                }
            }
        }
    }
    else if(dialogid == DIALOG_POLICE_HELI_BUY)
    {
        ...
        switch(listitem)
        {
            case 0: //maverick
            {
                ...
                VehicleFaction_Create(playerid, 497, FACTION_POLISI, 1777.045, -1776.630, 24.602, 266.312, 36, 36, 15000);
    ...
    else if(dialogid == DIALOG_POLICE_HELI_GARAGE_OUT)
    {
        ...
        PlayerVehicle[id][pVehPos][0] = 1777.045;
        PlayerVehicle[id][pVehPos][1] = -1776.630;
        PlayerVehicle[id][pVehPos][2] = 24.602;
        PlayerVehicle[id][pVehPos][3] = 266.312;
    ...
    else if(dialogid == DIALOG_POLICE_GARAGE)
    {
        ...
        switch(listitem)
        {
            case 0:// Keluarkan Kendaraan
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_POLICE_GARAGE_OUT, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Garasi Polda", list, "Pilih", "Batal");
            }
            case 1:// Simpan Kendaraan
            {
                new carid = -1, bool: foundnearby = false;
            ...
            case 2:// Beli Kendaraan
            {
                ShowPlayerDialog(playerid, DIALOG_POLICE_GARAGE_BUY, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Beli Kendaraan",
                "Model\tHarga\
                \nSultan Sabhara\t$5000\
    ...
    else if(dialogid == DIALOG_FEDERAL_GARAGE)
    {
        ...
        switch(listitem)
        {
            case 0:// Keluarkan Kendaraan
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_FEDERAL_GARAGE_OUT, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Garasi Federal", list, "Pilih", "Batal");
            }
            ...
            case 2:// Beli Kendaraan
            {
                ShowPlayerDialog(playerid, DIALOG_FEDERAL_GARAGE_BUY, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Beli Kendaraan",
                "Model\tHarga\
                \nSultan Sabhara\t$5000\
                \n"GRAY"Cheetah Speed Hunter\t"GRAY"$20000\
                \nBullet Speed Hunter\t$20000\
    ...
    else if(dialogid == DIALOG_POLICE_GARAGE_DEL)
    {
        ...
        if(rowscount)
        {
            ...
            if(listitem >= 0 && listitem < rowscount)
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Hapus Kendaraan", kckstr, "Tutup", "");
    ...
    {
        if(!response) return ShowTDN(playerid, NOTIFICATION_INFO, "Anda telah membatalkan pilihan");
        if(AccountData[playerid][pFaction] != FACTION_POLISI) return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan anggota Kepolisian Astral City!");
        if(AccountData[playerid][pInjured]) return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda sedang pingsan!");
        ...
        else 
        {
            ...
            ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Impound",
    ...
    else if(dialogid == DIALOG_PDM)
    {
        if(response)
        {
            if(AccountData[playerid][pFaction] != FACTION_POLISI) return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan anggota Kepolisan Astral City!");
            ...
            switch(listitem)
            {
                case 0: // Interaksi Kendaraan
                {
                    ...
                    ShowPlayerDialog(playerid, DIALOG_PDM_VEHICLE, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Interaksi Kendaraan",
                ...
                {
                    ShowPlayerDialog(playerid, DIALOG_PDM_OBJECT, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Mengeluarkan Object",
                ...
                case 2: // cek tahanan
                {
                    ...
                    if(count == 0)
                        ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- List Tahanan", "Tidak ada pemain dalam masa hukuman penjara!", "Tutup", "");
                    else
                        ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- List Tahanan", frmxt, "Tutup", "");
                }
            }
        }
        else
    ...
    else if(dialogid == DIALOG_PDM_VEHICLE)
    {
        ...
        if(AccountData[playerid][pFaction] != FACTION_POLISI) 
        {
            ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan anggota Kepolisian Astral City!");
            NearestVehicleID[playerid] = INVALID_VEHICLE_ID;
            return 1;
        }
        ...
        switch(listitem)
        {
            case 0: //vehicle info
            {
                ...
                foreach(new player : Player) if (AccountData[player][IsLoggedIn])
                {
                    ...
                    ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Informasi Kendaraan", sha, "Tutup", "");
                }
            }
            case 1: // Bobol
            {
            ...
            case 3: //Impound
            {
                ShowPlayerDialog(playerid, DIALOG_PDM_VEHICLE_IMPOUND, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Menyita Kendaraan",
    ...
    else if(dialogid == DIALOG_PDM_VEHICLE_IMPOUND)
    {
        ...
        if(isnull(inputtext)) return ShowPlayerDialog(playerid, DIALOG_PDM_VEHICLE_IMPOUND, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Menyita Kendaraan",
        "Error: Tidak dapat diisi kosong!\nHarap masukkan sesuai format yang ada dibawah ini!\n[Durasi sita [hari]] [denda] [alasan]", "Input", "Batal");

        new impoundtime, fee, reason[128];
        if(sscanf(inputtext, "dds[128]", impoundtime, fee, reason)) return ShowPlayerDialog(playerid, DIALOG_PDM_VEHICLE_IMPOUND, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Menyita Kendaraan",
        "Harap masukkan sesuai format yang ada dibawah ini!\n[Durasi sita [hari]] [denda] [alasan]", "Input", "Batal");

        if(impoundtime < 1 || impoundtime > 30) return ShowPlayerDialog(playerid, DIALOG_PDM_VEHICLE_IMPOUND, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Menyita Kendaraan",
        "Error: Maksimal waktu 30 hari!\nHarap masukkan sesuai format yang ada dibawah ini!\n[Durasi sita [hari]] [denda] [alasan]", "Input", "Batal");

        if(fee < 1) return ShowPlayerDialog(playerid, DIALOG_PDM_VEHICLE_IMPOUND, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Menyita Kendaraan",
...
CheckTargetWeapon(playerid, targetid)
{
    ...
    {
        PlayerPlaySound(playerid, 1085, 0.0, 0.0, 0.0);
        return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Kepemilikan Senjata",
        "Pemain tersebut tidak memiliki senjata apapun!", "Tutup", "");
    }
    ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Kepemilikan Senjata",
    frmtgun, "Tutup", "");
    return 1;
}
    ...
    if(response)
    {
        switch(listitem)
        {
            case 0:
            {
                ...
                \nDesert Eagle\t50\t$5000\
                \n"GRAY"M4A1\t200\t"GRAY"$18000\
                \nShotgun\t100\t$7000\
                \n"GRAY"MP-5\t150\t"GRAY"$9000\
                \nSniper\t50\t25000\
                \n"GRAY"Silenced\t100\t"GRAY"5000");
                Dialog_Show(playerid, BRGUNPOLICE, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Brankas Persenjataan", xjjs, "Beli", "Tutup");
            }
            case 1:// 
            {
...
{
    if(!response) return ShowTDN(playerid, NOTIFICATION_INFO, "Anda telah membatalkan pilihan!");
    if(GetPlayerFaction(playerid) != FACTION_POLISI) return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan bagian dari Polda Astral City!");
    switch(listitem)
    {
        case 0:// nDesert Eagle
        {
            new pricing = 5000;
            new weaponid = 24, ammo = 50;
        ...
        case 3:// MP-5
        {
            ...
            static frmtx[178];
            format(frmtx, sizeof(frmtx), "POLISI - Membeli MP5 Seharga $9000");
            AddFMoneyLog(AccountData[playerid][pName], AccountData[playerid][pUCP], 9000, frmtx);
        }
        case 4:// Sniper
        {
            new pricing = 25000;
            new weaponid = 34, ammo = 50;
            if(GetPlayerMoney(playerid) < pricing) return ShowTDN(playerid, NOTIFICATION_ERROR, "Uang tidak cukup!");
            ...
            static frmtx[178];
            format(frmtx, sizeof(frmtx), "POLISI - Membeli Sniper Seharga $25000");
            AddFMoneyLog(AccountData[playerid][pName], AccountData[playerid][pUCP], 25000, frmtx);
        }
        case 5:// silenced
        {
            new pricing = 5000;
            new weaponid = 23, ammo = 100;
            if(GetPlayerMoney(playerid) < pricing) return ShowTDN(playerid, NOTIFICATION_ERROR, "Uang tidak cukup!");
            ...
            static frmtx[178];
            format(frmtx, sizeof(frmtx), "POLISI - Membeli Spass Seharga $5000");
            AddFMoneyLog(AccountData[playerid][pName], AccountData[playerid][pUCP], 5000, frmtx);
        }
    }
    return 1;
    ...
    switch(listitem)
    {
        ...
        case 1:// 
        {
            if(AccountData[playerid][pGender] == 1) {
                Dialog_Show(playerid, Clothes_MaleSAPD, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Baju Dinas", ""WHITE"Sabhara\
                \n"GRAY"Polantas 1\n"WHITE"Polantas 2\n"GRAY"Brimob 1\n"WHITE"Brimob 2\n"GRAY"Propam\n"WHITE"Jenderal 1\
                \n"GRAY"Jenderal 2\n"WHITE"FBI\n"GRAY"DIV Udara\n"WHITE"Casis\n"GRAY"Rompi Kepolisian\nRompi SWAT", "Pilih", "Batal");
            } else {
                Dialog_Show(playerid, Clothes_FemaleSAPD, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Baju Dinas", ""WHITE"Sabhara\n"GRAY"Polantas\n"WHITE"Brimob\
                \n"GRAY"Rompi Kepolisian\nRompi SWAT", "Pilih", "Batal");
            }
        }
    }
...
CMD:pdm(playerid, params[])
{
    ...
    ShowPlayerDialog(playerid, DIALOG_PDM, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Police Menu",
    "Interaksi Kendaraan\
...
{
    if(AccountData[playerid][pFaction] != FACTION_POLISI) return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan anggota Polisi Astral City!");
    if(AccountData[playerid][pInjured]) return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda sedang pingsan!");
