...
VarsDoorPemerintah()
{
    PemerStuff[PemerDuty] = CreateDynamicSphere(1480.296, -1809.199, 13.672, 2.0, -1, -1, -1);
    PemerStuff[PemerBrankas] = CreateDynamicSphere(1508.144, -1812.800, 13.722, 2.0, -1, -1, -1);
    PemerStuff[PemerLocker] = CreateDynamicSphere(1510.659, -1810.556, 13.722, 2.0, -1, -1, -1);
    PemerStuff[PemerDesk] = CreateDynamicSphere(1510.541, -1794.051, 13.722, 2.0, -1, -1, -1);
    PemerStuff[PemerGarage] = CreateDynamicSphere(1435.533, -1770.735, 13.556, 2.0, -1, -1, -1);
    PemerStuff[PemerGaragePOS][0] = 1435.533;
    PemerStuff[PemerGaragePOS][1] = -1770.735;
    PemerStuff[PemerGaragePOS][2] = 13.556;
    
    PemerStuff[PemerSpawnPOS][0] = 1437.496;
    PemerStuff[PemerSpawnPOS][1] = -1771.048;
    PemerStuff[PemerSpawnPOS][2] = 13.566;
    PemerStuff[PemerSpawnPOS][3] = 268.697;
}
...
hook OnPlayerKeyStateChange(playerid, newkeys, oldkeys)
{
    if(newkeys & KEY_YES && GetPlayerState(playerid) == PLAYER_STATE_ONFOOT)
    {
        if(AccountData[playerid][pFaction] == FACTION_PEMERINTAH)
        {
            ...
            {
                ShowPlayerDialog(playerid, DIALOG_PEMERINTAH_LOCKER, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Locker Pemerintah", 
            ...
            if(IsPlayerInDynamicArea(playerid, PemerStuff[PemerDesk]) && AccountData[playerid][pDutyPemerintah])
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_PEMERINTAH_BOSDESK, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Bos Desk",
                "Invite\
                \n"GRAY"Kelola Jabatan\
                \nKick\
                \n"GRAY"Lihat Anggota\
            ...
            if(IsPlayerInDynamicArea(playerid, PemerStuff[PemerBrankas]) && AccountData[playerid][pDutyPemerintah])
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_PEMERVAULT, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Brankas Pemerintah",
            ...
            {
                ShowPlayerDialog(playerid, DIALOG_PEMER_GARAGE, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Garasi Pemerintah", 
                "Keluarkan Kendaraan\
...
hook OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
    ...
    switch(dialogid)
    {
        case DIALOG_PEMER_GARAGE:
        {
            ...
            if(AccountData[playerid][pFaction] != FACTION_PEMERINTAH) return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan bagian dari Pemerintah Daerah Kota Astral City!");
            ...
            switch(listitem)
            {
                case 0:// Keluarkan kendaraan
                {
                    ...
                    ShowPlayerDialog(playerid, DIALOG_PEMER_GARAGE_TAKEOUT, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Garasi Gojek", lstr, "Pilih", "Batal");
                }
                case 1://Simpan Kendaraan
                {
                    ...
                    if(!foundnearby) return ShowTDN(playerid, NOTIFICATION_ERROR, "Tidak ada kendaraan dari Pemerintah Astral City milik anda di sekitar!");
                }
                case 2://Beli Kendaraan
                {
                    ShowPlayerDialog(playerid, DIALOG_PEMER_GARAGE_BUY, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Beli Kendaraan",
                    "Model\tHarga\
                    \nStretch\t$8000\
                ...
                case 3:// Hapus Kendaraan
                {
                    ...
                    if(rows)
                    {
                        ...
                        ShowPlayerDialog(playerid, DIALOG_PEMER_GARAGE_DELETE, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Hapus Kendaraan", list, "Hapus", "Batal");
                    }
                    else 
                    {
                        PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
                        return Dialog_Show(playerid, ShowOnly, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Hapus Kendaraan", "Anda tidak memiliki kendaraan Pemerintah", "Tutup", "");
                    }
                }
            }
        }
        case DIALOG_PEMER_GARAGE_TAKEOUT:
        {
            ...
            if(AccountData[playerid][pFaction] != FACTION_PEMERINTAH) return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan anggota Pemerintah Astral City");
        ...
        {
            if(!response) return ShowTDN(playerid, NOTIFICATION_INFO, "Anda telah membatalkan pilihan");
            if(AccountData[playerid][pFaction] != FACTION_PEMERINTAH) return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan bagian dari Pemerintah Daerah Astral City!");
        ...
        case DIALOG_PEMERVAULT:
        {
            ...
            {
                AccountData[playerid][menuShowed] = false;   
                return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan anggota dari Pemerintah Daerah Kota Astral City!");
            }
            switch(listitem)
            {
                case 0: //deposit
                {
                    ...
                    if(rows) 
                    {
                        ...
                        ShowPlayerDialog(playerid, DIALOG_PEMERVAULT_DEPOSIT, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Brankas Pemerintah", str, "Pilih", "Batal");
                    }
                    else 
                    {
                        AccountData[playerid][menuShowed] = false;
                        PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
                        return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Brankas Pemerintah",
                ...
                case 1: //withdraw
                {
                    ...
                    if(cache_num_rows() > 0)
                    {
                        ...
                        ShowPlayerDialog(playerid, DIALOG_PEMERVAULT_WITHDRAW, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Brankas Pemerintah", str, "Pilih", "Batal");
                    }
                    else 
                    {
                        AccountData[playerid][menuShowed] = false;
        ...
        case DIALOG_PEMERVAULT_DEPOSIT:
        {
            ...
            if(cache_num_rows() > 0)
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_PEMERVAULT_IN, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas Pemerintah", 
                shstr, "Input", "Batal");
            }
        }
        case DIALOG_PEMERVAULT_IN:
        {
            ...
            if(PemerintahProcessing[playerid])
                return ShowTDN(playerid, NOTIFICATION_WARNING, "Sedang memproses permintaan, tunggu sebentar!");
            PemerintahProcessing[playerid] = true;

            if(!response)
            {
                PemerintahProcessing[playerid] = false;
                AccountData[playerid][menuShowed] = false;
                return ShowTDN(playerid, NOTIFICATION_INFO, "Anda telah membatalkan pilihan");
            }
            ...
            if(isnull(inputtext) || !IsNumeric(inputtext))
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_PEMERVAULT_IN, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas Pemerintah", shstr, "Input", "Batal");
                PemerintahProcessing[playerid] = false;
                return 1;
            }
            ...
            if(requested > avail) requested = avail; // batasi ke jumlah yang ada di inventory
            ...
            if(rows > 0)
            {
                mysql_format(g_SQL, invstr, sizeof(invstr), "UPDATE `pemerintah_brankas` SET `Quantity` = `Quantity` + %d WHERE `PID`=0 AND `Item`='%s'",
                    requested, FactionBrankas[playerid][factionBrankasTemp]);
                mysql_tquery(g_SQL, invstr, "OnPemerintahDeposit", "i", playerid);
            }
            else
            {
                mysql_format(g_SQL, invstr, sizeof(invstr), "INSERT INTO `pemerintah_brankas` SET `PID`=0, `Item`='%s', `Model`=%d, `Quantity`=%d",
        ...
        case DIALOG_PEMERVAULT_WITHDRAW:
        {
            ...
            if(cache_num_rows() > 0)
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_PEMERVAULT_OUT, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas Pemerintah",
                shstr, "Input", "Batal");
            }
            else 
            {
                AccountData[playerid][menuShowed] = false;
                ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Brankas Pemerintah",
        ...
        case DIALOG_PEMERINTAH_BOSDESK:
        {
            ...
            switch(listitem)
            {
                case 0: //invite
                {
                    ...
                    ShowPlayerDialog(playerid, DIALOG_PEMERINTAH_INVITE, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Invite", frmxt, "Pilih", "Batal");
                }
                case 1:// Kelola Jabatan Offline / Online
                {
                    ...
                    if(rows)
                    {
                        ...
                        ShowPlayerDialog(playerid, DIALOG_PEMERSETRANK, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Set Jabatan", shstr, "Pilih", "Batal");
                    }
                    else 
                    {
                        PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
                        return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Set Jabatan", "Tidak ada Anggota Pemerintah!", "Tutup", "");
                    }
                }
                case 2:// kick offline / online
                {
                    ...
                    if(rows)
                    {
                        ...
                        ShowPlayerDialog(playerid, DIALOG_PEMERKICKMEMBER, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Kick Anggota", shstr, "Pilih", "Batal");
                    }
                    else 
                    {
                        PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
                        return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Kick Anggota", "Tidak ada Anggota Pemerintahan!", "Tutup", "");
                    }
                }
                ...
                {
                    new frmxt[158];
                    format(frmxt, sizeof(frmxt), "Pemerintahan Daerah Astral City saat ini memiliki saldo sebesar:\ 
                    \n"DARKGREEN"%s", FormatMoney(PemerintahMoneyVault));
                    ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Pemerintah Money", frmxt, "Tutup", "");
                }
                case 5:// Deposit Uang
                {
                    ShowPlayerDialog(playerid, DIALOG_PEMERINTAH_DEPOSIT, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Pemerintah Deposit",
                    "Mohon masukkan nominal deposit untuk saldo finansial:", "Input", "Batal");
                }
                case 6: // Tarik Uang
                {
                    ShowPlayerDialog(playerid, DIALOG_PEMERINTAH_WITHDRAW, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Pemerintah Withdraw",
        ...
        case DIALOG_PEMERINTAH_DEPOSIT:
        {
            ...
            ShowTDN(playerid, NOTIFICATION_SUKSES, sprintf("Anda berhasil deposit %s ke Pemerintah Astral City", FormatMoney(depocash)));
        } 
        case DIALOG_PEMERINTAH_WITHDRAW:
        {
            ...
            ShowTDN(playerid, NOTIFICATION_SUKSES, sprintf("Anda berhasil withdraw %s dari Pemerintah Astral City", FormatMoney(withdrawcash)));
        }
            ...
            if(cache_num_rows())
            {
                ...
                foreach(new i : Player)
                {
                    if(AccountData[i][IsLoggedIn] && AccountData[i][pSpawned] && pidrow == AccountData[i][pID])
                    {
                        ...
                        RefreshFactionMap(i);
                        ShowTDN(i, NOTIFICATION_WARNING, "Anda telah dikeluarkan dari faction Pemerintah Astral City!");
                    }
                }
        ...
        case DIALOG_PEMERSETRANK:
        {
            ...
            if(rows)
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_RANK_SET_PEMERINTAH, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Kelola Jabatan", \
        ...
        case DIALOG_RANK_SET_PEMERINTAH:
        {
            ...
            if(isnull(inputtext)) return ShowPlayerDialog(playerid, DIALOG_RANK_SET_PEMERINTAH, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Kelola Jabatan", \
            ...
            if(!IsNumeric(inputtext)) return ShowPlayerDialog(playerid, DIALOG_RANK_SET_PEMERINTAH, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Kelola Jabatan", \
            ...
            if(strval(inputtext) < 1 || strval(inputtext) > AccountData[playerid][pFactionRank]) return ShowPlayerDialog(playerid, DIALOG_RANK_SET_PEMERINTAH, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Kelola Jabatan", \
        ...
        case DIALOG_PEMERINTAH_PANEL:
        {
            ...
            if(AccountData[playerid][pFaction] != FACTION_PEMERINTAH) return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan bagian dari Pemerintah Kota Astral City!");
            ...
            switch(listitem)
            {
                ...
                case 1:// Switch Pakaian
                {
                    if(AccountData[playerid][pGender] == 1) {
                        ShowPlayerDialog(playerid, DIALOG_PEMERINTAH_LOCKERMALE, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Baju Dinas", ""WHITE"Pemerintah 1\n"GRAY"Pemerintah 2\n"WHITE"Pemerintah 3", "Pilih", "Batal");
                    } else {
                        ShowPlayerDialog(playerid, DIALOG_PEMERINTAH_LOCKERFEMALE, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Baju Dinas", ""WHITE"Pemerintah 1\n"GRAY"Pemerintah 2", "Pilih", "Batal");
                    }
                }
            }
        }
...
{
    if(AccountData[playerid][pFaction] != FACTION_PEMERINTAH)
        return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan bagian dari Pemerintah Kota Astral City!");
