...
enum e_emsstuff
{
    ...
    STREAMER_TAG_AREA:EMSHeli[2],
};
new EMSStuff[e_emsstuff];
new STREAMER_TAG_OBJECT: EMSObject[MAX_PLAYERS][8];
...
VarsDoorEms()
{
    EMSStuff[EMSDuty] = CreateDynamicSphere(1317.350, -1354.152, 13.669, 2.0, 0, 0, -1);
    EMSStuff[EMSGarage] = CreateDynamicSphere(1327.646, -1379.287, 13.668, 2.0, 0, 0, -1);	
    EMSStuff[EMSBrankas] = CreateDynamicSphere(1295.626, -1373.173, 13.579, 2.0, 0, 0, -1);
    EMSStuff[EMSLocker] = CreateDynamicSphere(1292.737, -1373.270, 13.574, 2.0, 0, 0, -1);
    EMSStuff[EMSDesk] = CreateDynamicSphere(1321.586, -1354.120, 13.669, 2.0, 0, 0, -1);
    EMSStuff[EMSItemsLocker] = CreateDynamicSphere(1285.188, -1367.242, 13.669, 2.0, 0, 0, -1);
    EMSStuff[EMSHeli][0] = CreateDynamicSphere(1315.108, -1363.812, 45.171, 2.0, 0, 0, -1);
    EMSStuff[EMSHeli][1] = CreateDynamicSphere(1294.523, -1363.850, 45.170, 2.0, 0, 0, -1);
    EMSStuff[EMSGaragePOS][0] = 1327.646;
    EMSStuff[EMSGaragePOS][1] = -1379.287;
    EMSStuff[EMSGaragePOS][2] = 13.668;
    
    EMSStuff[EMSSpawnPOS][0] = 1313.359;
    EMSStuff[EMSSpawnPOS][1] = -1379.936;
    EMSStuff[EMSSpawnPOS][2] = 13.618;
    EMSStuff[EMSSpawnPOS][3] = 269.956;
}
...
hook OnPlayerKeyStateChange(playerid, newkeys, oldkeys)
{
    if(newkeys & KEY_YES && GetPlayerState(playerid) == PLAYER_STATE_ONFOOT)
    {
        if(AccountData[playerid][pFaction] == FACTION_EMS)
        {
            ...
            {
                ShowPlayerDialog(playerid, DIALOG_EMS_LOCKER, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Locker EMS",
            ...
            if(IsPlayerInDynamicArea(playerid, EMSStuff[EMSDesk]) && AccountData[playerid][pDutyEms])
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_EMS_BOSDESK, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Bos Desk",
                "Invite\
                \n"GRAY"Kelola Jabatan\
                \nKick\
                \n"GRAY"Lihat Anggota\
            ...
            if(IsPlayerInDynamicArea(playerid, EMSStuff[EMSHeli][0]) && AccountData[playerid][pDutyEms])
            {
                ...
                if(!EMSSpawnHeli[playerid])
                {
                    EMSHeliVeh[playerid] = AddStaticVehicleEx(487,1315.108, -1363.812, 45.171, 181.892, 3, 1, 60000, 1);
            ...
            if(IsPlayerInDynamicArea(playerid, EMSStuff[EMSHeli][1]) && AccountData[playerid][pDutyEms])
            {
                if(GetPlayerState(playerid) != PLAYER_STATE_ONFOOT) return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda harus diluar kendaraan!");
                if(AccountData[playerid][pInjured]) return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda sedang pingsan!");
                if(!EMSSpawnHeli[playerid])
                {
                    EMSHeliVeh[playerid] = AddStaticVehicleEx(487,1294.523, -1363.850, 45.170, 180.639, 3, 1, 60000, 1);
                    VehicleCore[EMSHeliVeh[playerid]][vCoreFuel] = MAX_FUEL_FULL;
                    PutPlayerInVehicle(playerid, EMSHeliVeh[playerid], 0);
                    EMSSpawnHeli[playerid] = true;
                }
            ...
            {
                ShowPlayerDialog(playerid, DIALOG_EMS_GARAGE, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Garasi EMS",
                "Keluarkan Kendaraan\
            ...
            if(IsPlayerInDynamicArea(playerid, EMSStuff[EMSBrankas]) && AccountData[playerid][pDutyEms])
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_EMSVAULT, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Brankas EMS",
            ...
            if(IsPlayerInDynamicArea(playerid, EMSStuff[EMSItemsLocker]) && AccountData[playerid][pDutyEms])
            {
                ...
                Dialog_Show(playerid, Brankas_Ems, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Brankas Ems", sstr, "Pilih", "Batal");
            }
        }
    }
    return 1;
...
hook OnPlayerEnterDynArea(playerid, STREAMER_TAG_AREA:areaid)
{
    if(AccountData[playerid][pFaction] == FACTION_EMS)
    {
        ...
        for(new i; i < 2; i ++)
        {
            if(areaid == EMSStuff[EMSHeli][i] && AccountData[playerid][pDutyEms])
            {
                if(!EMSSpawnHeli[playerid])
                {
...
Dialog:Brankas_Ems(playerid, response, listitem, inputtext[])
{
    if(response)
    {
        switch(listitem)
        {
            case 0:
            {
                Dialog_Show(playerid, Perban_Ems, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas EMS", "Mohon ikuti sesuai format berikut:\n[ambil] [jumlah] atau [depo] [jumlah]\nMohon masukkan tanpa tanda ][ pada kolom dibawah ini:", "Input", "Batal");
            }
            case 1:
            {
                Dialog_Show(playerid, Medkit_Ems, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas EMS", "Mohon ikuti sesuai format berikut:\n[ambil] [jumlah] atau [depo] [jumlah]\nMohon masukkan tanpa tanda ][ pada kolom dibawah ini:", "Input", "Batal");
            }
            case 2:
            {
                Dialog_Show(playerid, Pill_Ems, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas EMS", "Mohon ikuti sesuai format berikut:\n[ambil] [jumlah] atau [depo] [jumlah]\nMohon masukkan tanpa tanda ][ pada kolom dibawah ini:", "Input", "Batal");
            }
        }
    }
    ...
    switch(dialogid)
    {
        case DIALOG_EMSBRANKAS:
        {
            ...
            switch(listitem)
            {
                case 0:// perban
                {
                    ShowPlayerDialog(playerid, DIALOG_EMSBKCONFIRM, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas EMS",
        ...
        case DIALOG_EMSBKCONFIRM:
        {
            ...
            if(AccountData[playerid][pFaction] != FACTION_EMS) return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan anggota EMS Astral City!");
            if(isnull(inputtext)) return ShowPlayerDialog(playerid, DIALOG_EMSBKCONFIRM, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas EMS",
            "Error: Tidak dapat dikosongkan!\
            \n( Masukkan berapa jumlah yang ingin anda beli! )", "Input", "Batal");
            if(!IsNumeric(inputtext)) return ShowPlayerDialog(playerid, DIALOG_EMSBKCONFIRM, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas EMS",
        ...
        case DIALOG_EMS_GARAGE:
        {
            ...
            switch(listitem)
            {
                case 0: //takeout
                {
                    ...
                    ShowPlayerDialog(playerid, DIALOG_EMS_GARAGE_TAKEOUT, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Garasi EMS", lstr, "Pilih", "Batal");
                }
                ...
                {
                    ShowPlayerDialog(playerid, DIALOG_EMS_GARAGE_BUY, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Garasi EMS",
                    "Model\tHarga\
                    \nAmbulance\t$5000\
                ...
                case 3:// Hapus Kendaraan
                {
                    ...
                    if(rowscount)
                    {
                        ...
                        ShowPlayerDialog(playerid, DIALOG_EMS_GARAGE_DELETE, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Hapus Kendaraan", list, "Hapus", "Batal");
                    }
                    else 
                    {
                        PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
                        return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Hapus Kendaraan", "Anda tidak memiliki kendaraan EMS.", "Tutp", "");
                    }
                }
            }
        }
            ...
            switch(listitem)
            {
                case 0: //deposit
                {
                    ...
                    if(rows) 
                    {
                        ...
                        ShowPlayerDialog(playerid, DIALOG_EMSVAULT_DEPOSIT, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Brankas EMS", str, "Pilih", "Batal");
                    }
                    else 
                    {
                        AccountData[playerid][menuShowed] = false;
                        PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
                        return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Brankas EMS",
                ...
                case 1: //withdraw
                {
                    ...
                    if(cache_num_rows() > 0)
                    {
                        ...
                        ShowPlayerDialog(playerid, DIALOG_EMSVAULT_WITHDRAW, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Brankas EMS", str, "Pilih", "Batal");
                    }
                    else 
                    {
                        AccountData[playerid][menuShowed] = false;
        ...
        case DIALOG_EMSVAULT_DEPOSIT:
        {
            ...
            if(cache_num_rows() > 0)
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_EMSVAULT_IN, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas EMS", 
                shstr, "Input", "Batal");
            }
        }
        case DIALOG_EMSVAULT_IN:
        {
            if(EMSProcessing[playerid])
                return ShowTDN(playerid, NOTIFICATION_WARNING, "Sedang memproses permintaan, tunggu sebentar!");
            EMSProcessing[playerid] = true;

            if(!response)
            {
                EMSProcessing[playerid] = false;
                AccountData[playerid][menuShowed] = false;
                return ShowTDN(playerid, NOTIFICATION_INFO, "Anda telah membatalkan pilihan");
            }
            ...
            if(isnull(inputtext) || !IsNumeric(inputtext))
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_EMSVAULT_IN, DIALOG_STYLE_INPUT, 
                    "TTR Astral City Roleplay - Brankas EMS", shstr, "Input", "Batal");
                EMSProcessing[playerid] = false;
                return 1;
            }
            ...
            if(rows > 0)
            {
                mysql_format(g_SQL, invstr, sizeof(invstr), 
                    "UPDATE `ems_brankas` SET `Quantity` = `Quantity` + %d WHERE `PID` = 0 AND `Item`='%s'", 
            ...
            {
                mysql_format(g_SQL, invstr, sizeof(invstr), 
                    "INSERT INTO `ems_brankas` SET `PID`=0, `Item`='%s', `Model`=%d, `Quantity`=%d", 
        ...
        case DIALOG_EMSVAULT_WITHDRAW:
        {
            ...
            if(cache_num_rows() > 0)
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_EMSVAULT_OUT, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas EMS",
                shstr, "Input", "Batal");
            }
            else 
            {
                AccountData[playerid][menuShowed] = false;
                ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Brankas EMS",
        ...
        {
            if(!response) return ShowTDN(playerid, NOTIFICATION_INFO, "Anda telah membatalkan pilihan");
            if(AccountData[playerid][pFaction] != FACTION_EMS) return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan bagian dari EMS Astral City!");
        ...
        case DIALOG_EMS_BOSDESK:
        {
            ...
            switch(listitem)
            {
                case 0: //invite
                {
                    ...
                    ShowPlayerDialog(playerid, DIALOG_EMS_INVITE, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Invite", frmxt, "Pilih", "Batal");
                }
                case 1:// Kelola Jabatan
                {
                    ...
                    if(rows)
                    {
                        ...
                        ShowPlayerDialog(playerid, DIALOG_EMSSETRANK, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Set Jabatan", shstr, "Pilih", "Batal");
                    }
                    else 
                    {
                        PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
                        return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Set Jabatan", "Tidak ada Anggota EMS!", "Tutup", "");
                    }
                }
                case 2:// Kick Offline / Online
                {
                    ...
                    if(rows)
                    {
                        ...
                        ShowPlayerDialog(playerid, DIALOG_EMSKICKMEMBER, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Kick Anggota", shstr, "Kick", "Batal");
                    }
                    else 
                    {
                        PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
                        return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Kick Anggota", "Tidak ada Anggota EMS!", "Tutup", "");
                    }
                }
                ...
                case 4:// Saldo Finansial
                {
                    ...
                    ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- EMS Money", frmxt, "Tutup", "");
                }
                case 5:// Deposit saldo
                {
                    ShowPlayerDialog(playerid, DIALOG_DEPOSIT_EMS, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- EMS Deposit", 
                    "Mohon masukkan nominal deposit untuk saldo perusahaan:", "Input", "Batal");
                }
                case 6://
                {
                    ShowPlayerDialog(playerid, DIALOG_WITHDRAW_EMS, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- EMS Withdraw", 
            ...
            if(cache_num_rows())
            {
                ...
                foreach(new i : Player)
                {
                    if(AccountData[i][IsLoggedIn] && AccountData[i][pSpawned] && pidrow == AccountData[i][pID])
                    {
                        ...
                        ShowTDN(i, NOTIFICATION_WARNING, "Anda telah dikeluarkan dari faction EMS Astral City!");
                    }
                }
        ...
        case DIALOG_EMSSETRANK:
        {
            ...
            if(rows)
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_RANK_SET_EMS, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Kelola Jabatan", \
        ...
        case DIALOG_RANK_SET_EMS:
        {
            ...
            if(isnull(inputtext)) return ShowPlayerDialog(playerid, DIALOG_RANK_SET_EMS, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Kelola Jabatan", \
            ...
            if(!IsNumeric(inputtext)) return ShowPlayerDialog(playerid, DIALOG_RANK_SET_EMS, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Kelola Jabatan", \
            "Error: Hanya dapat diisi angka!\n\
            Silahkan pilih jabatan untuk ditetapkan (masukkan angka saja):\n\
            1. Training\n\
            2. Perawat\n\
            ...
            if(strval(inputtext) < 1 || strval(inputtext) > AccountData[playerid][pFactionRank]) return ShowPlayerDialog(playerid, DIALOG_RANK_SET_EMS, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Kelola Jabatan", \
        ...
        case DIALOG_EMS_LOCKER:
        {
            ...
            switch(listitem)
            {
                ...
                case 1:
                {
                    ShowPlayerDialog(playerid, DIALOG_EMS_CLOTHES, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Lemari EMS", 
                    "Dokter 1\ 
                    \n"GRAY"Dokter 2\ 
                    \nDokter 3\ 
...
public EMSReviving(playerid, targetid)
{
    ...
    if(AccountData[playerid][ActivityTime] >= 10)
    {
        ...
        if(AccountData[targetid][pInjured])
        {
            ...
            for(new i = 0; i < 42; i ++)
		{
			PlayerTextDrawHide(playerid, InjuredSytems[targetid][i]);
		}
        }
