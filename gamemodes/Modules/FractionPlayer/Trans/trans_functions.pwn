    ...
    if(newkeys & KEY_YES && GetPlayerState(playerid) == PLAYER_STATE_ONFOOT)
    {
        if(AccountData[playerid][pFaction] == FACTION_TRANS)
        {
            ...
            if(IsPlayerInDynamicArea(playerid, Trans_Stuff[TransStorage]) && AccountData[playerid][pDutyTrans])
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_TRANSVAULT, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Brankas Trans",
                "Simpan Barang\n"GRAY"Ambil Barang", "Pilih", "Batal");
            }

            if(IsPlayerInDynamicArea(playerid, Trans_Stuff[TransLocker]) && AccountData[playerid][pDutyTrans])
            {
                ShowPlayerDialog(playerid, DIALOG_TRANS_LOCKER, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Locker Trans",
                "Baju Biasa\n"GRAY"Baju 1\nBaju 2", "Pilih", "Batal");
            }
            ...
            if(IsPlayerInDynamicArea(playerid, Trans_Stuff[TransDesk]) && AccountData[playerid][pDutyTrans])
            {
				...
				ShowPlayerDialog(playerid, DIALOG_TRANS_DESK, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Bos Desk",
				"Invite\
				\n"GRAY"Kelola Jabatan\
				\nKick\
				\n"GRAY"Lihat Anggota\
            ...
            {
                ShowPlayerDialog(playerid, DIALOG_TRANS_GARAGE, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Garasi Trans",
                "Keluarkan Kendaraan\
...
hook OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
    switch(dialogid)
    {
        case DIALOG_TRANS_DESK:
        {
            ...
            switch(listitem)
            {
                case 0:
                {
					...
					ShowPlayerDialog(playerid, DIALOG_TRANS_INVITECONF, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Invite", frmxt, "Pilih", "Batal");
                }
                case 1:
                {
					...
					if(rows)
					{
						...
						ShowPlayerDialog(playerid, DIALOG_TRANSSETRANK, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Set Jabatan", shstr, "Pilih", "Batal");
					}
					else 
					{
						PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
						return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Set Jabatan", "Tidak ada Anggota Trans!", "Tutup", "");
					}
                }
                case 2:
                {
					...
					if(rows)
					{
						...
						ShowPlayerDialog(playerid, DIALOG_TRANSKICKMEMBER, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Kick Anggota", shstr, "Kick", "Batal");
					}
					else 
					{
						PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
						return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Kick Anggota", "Tidak ada Anggota Trans!", "Tutup", "");
					}
                }
                case 3:
                {
					...
					ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Anggota", list, "Tutup", "");
                }
                case 4:
                {
                    new frmxt[158];
					...
					ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Trans Money", frmxt, "Tutup", "");
                }
				case 5:
				{
					ShowPlayerDialog(playerid, DIALOG_DEPOSIT_TRANS, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Trans Deposit",
					"Mohon masukkan nominal deposit untuk saldo perusahaan:", "Input", "Batal");
				}
				case 6:
				{
					ShowPlayerDialog(playerid, DIALOG_WITHDRAW_TRANS, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Trans Withdraw",
        ...
        {
            if(!response) return 1;
            if(AccountData[playerid][pFaction] != FACTION_TRANS) return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan anggota Tansportasi Astral City!");
            if(AccountData[playerid][pFactionRank] < 4) return ShowTDN(playerid, NOTIFICATION_ERROR, "Minimal rank Kepala Transport untuk akses desk!");
            ...
            if(rows)
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_RANK_SET_TRANS, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Kelola Jabatan",
            ...
            if(cache_num_rows())
            {
                ...
                foreach(new i : Player)
                {
                    if(AccountData[i][IsLoggedIn] && AccountData[i][pSpawned] && pidrow == AccountData[i][pID])
                    {
                        ...
                        RefreshFactionMap(i);
                        ShowTDN(i, NOTIFICATION_WARNING, "Anda telah dikeluarkan dari faction Transportasi Astral City!");
                    }
                }
        ...
        case DIALOG_RANK_SET_TRANS:
		{
			...
			if(isnull(inputtext)) return ShowPlayerDialog(playerid, DIALOG_RANK_SET_TRANS, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Kelola Jabatan", \
			...
			if(!IsNumeric(inputtext)) return ShowPlayerDialog(playerid, DIALOG_RANK_SET_TRANS, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Kelola Jabatan", \
			...
			if(strval(inputtext) < 1 || strval(inputtext) > AccountData[playerid][pFactionRank]) return ShowPlayerDialog(playerid, DIALOG_RANK_SET_TRANS, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Kelola Jabatan", \
        ...
        case DIALOG_TRANS_GARAGE:
        {
            ...
            switch(listitem)
            {
                case 0: //takeout
                {
                    ...
                    ShowPlayerDialog(playerid, DIALOG_TRANS_GARAGE_TAKEOUT, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Garasi Trans", list, "Pilih", "Batal");
                }
                case 1:// in
				{
					...
					if((carid = Vehicle_Nearest(playerid, 10.0)) != -1)
					{
						...
						if(PlayerVehicle[carid][pVehFaction] != FACTION_TRANS) return ShowTDN(playerid, NOTIFICATION_ERROR, "Kendaraan tersebut bukan kendaraan Trans Astral City!");
                ...
                case 2: //buy
                {
                    ShowPlayerDialog(playerid, DIALOG_TRANS_GARAGE_BUY, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Beli Kendaraan",
                    "Model\tHarga\
                    \nTaxi\t$8500\
                ...
                case 3:// Hapus Kendaraan
				{
					...
					if(rows)
					{
						...
						ShowPlayerDialog(playerid, DIALOG_TRANS_GARAGE_DELETE, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Hapus Kendaraan", list, "Hapus", "Batal");
					}
					else 
					{
						PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
						return Dialog_Show(playerid, ShowOnly, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Hapus Kendaraan", "Anda tidak memiliki kendaraan Trans", "Tutup", "");
					}
				}
            }
        }
        ...
        case DIALOG_TRANSVAULT:
		{
            ...
            {
                AccountData[playerid][menuShowed] = false;   
                return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan anggota Transportasi Astral City!");
            }
			switch(listitem)
			{
				case 0: //deposit
                {
                    ...
                    if(rows) 
                    {
                        ...
                        ShowPlayerDialog(playerid, DIALOG_TRANSVAULT_DEPOSIT, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Brankas Trans", str, "Pilih", "Batal");
                    }
                    else 
                    {
                        AccountData[playerid][menuShowed] = false;
                        PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
                        return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Brankas Trans",
                ...
                case 1: //withdraw
                {
                    ...
                    if(cache_num_rows() > 0)
                    {
                        ...
                        ShowPlayerDialog(playerid, DIALOG_TRANSVAULT_WITHDRAW, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Brankas Trans", str, "Pilih", "Batal");
                    }
                    else 
                    {
                        AccountData[playerid][menuShowed] = false;
        ...
        case DIALOG_TRANSVAULT_DEPOSIT:
		{
            ...
            if(cache_num_rows() > 0)
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_TRANSVAULT_IN, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas Trans", 
                shstr, "Input", "Batal");
            }
		}
        case DIALOG_TRANSVAULT_IN:
        {
            if(TransProcessing[playerid])
                return ShowTDN(playerid, NOTIFICATION_WARNING, "Sedang memproses permintaan, tunggu sebentar!");
            TransProcessing[playerid] = true;

            if(!response)
            {
                TransProcessing[playerid] = false;
                AccountData[playerid][menuShowed] = false;
                return 1;
            }
            ...
            if(isnull(inputtext) || !IsNumeric(inputtext))
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_TRANSVAULT_IN, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas Trans", shstr, "Input", "Batal");
                TransProcessing[playerid] = false;
                return 1;
            }
            ...
            if(rows > 0)
            {
                mysql_format(g_SQL, invstr, sizeof(invstr), "UPDATE `trans_brankas` SET `Quantity` = `Quantity` + %d WHERE `PID`=0 AND `Item`='%s'", requested, FactionBrankas[playerid][factionBrankasTemp]);
                mysql_tquery(g_SQL, invstr, "OnTransDeposit", "i", playerid);
            }
            else 
            {
                mysql_format(g_SQL, invstr, sizeof(invstr), "INSERT INTO `trans_brankas` SET `PID`=0, `Item`='%s', `Model`=%d, `Quantity`=%d", FactionBrankas[playerid][factionBrankasTemp], FactionBrankas[playerid][factionBrankasModel], requested);
                mysql_tquery(g_SQL, invstr, "OnTransDeposit", "i", playerid);
            }
        ...
        case DIALOG_TRANSVAULT_WITHDRAW:
		{
            ...
            if(cache_num_rows() > 0)
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_TRANSVAULT_OUT, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas Trans",
                shstr, "Input", "Batal");
            }
            else 
            {
                AccountData[playerid][menuShowed] = false;
                ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Brankas Trans",
