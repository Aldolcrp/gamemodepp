...
hook OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
    switch(dialogid)
    {
        case DIALOG_TRANSORDER:
        {
            ...
            if(isnull(inputtext))
            {
                ShowPlayerDialog(playerid, DIALOG_TRANSORDER, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Pesan Transportasi",
...
{
    if(AccountData[playerid][pFaction] != FACTION_TRANS) return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan bagian dari Transportasi Astral City!");
