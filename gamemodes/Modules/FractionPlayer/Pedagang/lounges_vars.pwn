...
hook OnGameModeInit()
{
    Pedagang_Stuff[PdgDuty] = CreateDynamicSphere(953.919, -1653.237, 13.679, 1.5, 0, 0, -1);
    Pedagang_Stuff[PdgLocker] = CreateDynamicSphere(967.031, -1647.252, 17.869, 1.5, 0, 0, -1);
    Pedagang_Stuff[PdgGarasi] = CreateDynamicSphere(946.970, -1650.656, 13.664, 1.5, 0, 0, -1);
    Pedagang_Stuff[PdgCooking] = CreateDynamicSphere(953.471, -1647.693, 13.664, 1.5, 0, 0, -1);
    Pedagang_Stuff[PdgDesk] = CreateDynamicSphere(954.075, -1647.218, 17.869, 1.5, 0, 0, -1);
    Pedagang_Stuff[PdgKulkas] = CreateDynamicSphere(969.557, -1647.539, 13.664, 1.5, 0, 0, -1);
    ...
    Pedagang_Stuff[PdggaragePos][0] = 946.970;
    Pedagang_Stuff[PdggaragePos][1] = -1650.656;
    Pedagang_Stuff[PdggaragePos][2] = 13.664;

    Pedagang_Stuff[pdggarageSpawnPos][0] = 945.338;
    Pedagang_Stuff[pdggarageSpawnPos][1] = -1652.107;
    Pedagang_Stuff[pdggarageSpawnPos][2] = 13.664;
    Pedagang_Stuff[pdggarageSpawnPos][3] = 88.974;
}
...
Dialog:DIALOG_PEDAGANG_PANEL(playerid, response, listitem, inputtext[])
{
    ...
    if(AccountData[playerid][pFaction] != FACTION_PEDAGANG) return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan bagian dari Pedagang Astral City!");
...
hook OnPlayerKeyStateChange(playerid, newkeys, oldkeys)
{
    if(newkeys & KEY_YES && GetPlayerState(playerid) == PLAYER_STATE_ONFOOT)
    {
        if(AccountData[playerid][pFaction] == FACTION_PEDAGANG)
        {
            ...
            {
                ShowPlayerDialog(playerid, DIALOG_LOCKERPEDAGANG, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Locker Pedagang",
                "Baju Biasa\
                \n"GRAY"Pedagang 1\
                \nPedagang 2\
            ...
            if((IsPlayerInDynamicArea(playerid, Pedagang_Stuff[PdgCooking]) || IsPlayerInDynamicArea(playerid, Pedagang_Stuff[PdgCookingEms])) && AccountData[playerid][pDutyPedagang])
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_LOUNGES_MASAK, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Dapur Pedagang",
            ...
            if((IsPlayerInDynamicArea(playerid, Pedagang_Stuff[PdgKulkas]) || IsPlayerInDynamicArea(playerid, Pedagang_Stuff[PdgKulkasEms])) && AccountData[playerid][pDutyPedagang])
            {
                ...
                Dialog_Show(playerid, BrankasLounge, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Brankas Pedagang", shstr, "Pilih", "Batal");
                HideShortKey(playerid);
            }
            ...
            {
                ShowPlayerDialog(playerid, DIALOG_PEDAGANG_GARAGE, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Garasi Pedagang",
                "Keluarkan Kendaraan\
            ...
            if(IsPlayerInDynamicArea(playerid, Pedagang_Stuff[PdgDesk]))
            {
                ...
                Dialog_Show(playerid, BosDesk_Pedagang, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Bos Desk",
                "Invite\
                \n"GRAY"Kelola Jabatan\
                \nKick\
                \n"GRAY"Lihat Anggota\
                ...
                \n"GRAY"Deposit Saldo\
                \nWithdraw Saldo\
                \n"GRAY"Logs Acc Pesanan", "Pilih", "Batal");
                HideShortKey(playerid);
            }
        }
    }
    ...
    if(response)
    {
        switch(listitem)
        {
            case 0:
            {
                ...
                Dialog_Show(playerid, Pedagang_Invite, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Bos Desk", frmxt, "Pilih", "Batal");
            }
            case 1: // Kelola Jabatan offline / online
			{
                ...
                if(rows)
                {
                    ...
                    ShowPlayerDialog(playerid, DIALOG_PEDSETRANK, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Set Jabatan", shstr, "Pilih", "Batal");
                }
                else 
                {
                    PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
                    return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Set Jabatan", "Tidak ada Anggota Pedagang!", "Tutup", "");
                }
			}
			case 2:
			{
                ...
                if(rows)
                {
                    ...
                    ShowPlayerDialog(playerid, DIALOG_PEDKICKMEMBER, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Kick Anggota", shstr, "Kick", "Batal");
                }
                else 
                {
                    PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
                    return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Kick Anggota", "Tidak ada Anggota Bengkel!", "Tutup", "");
                }
			}
			case 3:
			{
			...
			case 4:
			{
				...
				Dialog_Show(playerid, ShowOnly, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Saldo Finansial", sstr, "Close", "");
			}
			case 5:
			{
				new sstr[512];
				...
				Dialog_Show(playerid, SaldoPedagangDeposit, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas Pedagang", sstr, "Input", "Batal");
			}
			case 6:
			{
				new sstr[512];
				format(sstr, sizeof sstr, "Mohon ikuti format berikut:\nGunakanlah format ambil [jumlah] untuk menarik saldo dari Brankas\nGunakan tanpa tanda ][ pada kolom dibawah ini:");
				Dialog_Show(playerid, SaldoPedagangWithdraw, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas Pedagang", sstr, "Input", "Batal");
			}
            case 7:
            {
                if (AccountData[playerid][pFaction] != FACTION_PEDAGANG)
                    return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan pedagang!");

                new q[128];
                mysql_format(g_SQL, q, sizeof(q),
                    "SELECT `pedagang_name`, `total_acc` FROM `%s` ORDER BY `total_acc` DESC LIMIT 100",
                    TABLE_ACC_LOGS);
                mysql_tquery(g_SQL, q, "OnShowLogsAccList", "i", playerid);
            }
        }
    }
...
Dialog:SaldoPedagangDeposit(playerid, response, listitem, inputtext[])
{
    ...
    if(AccountData[playerid][pFaction] != FACTION_PEDAGANG) return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan bagian dari pedagang kota ASTRALCITY!");
    if(response)
    {
...
Dialog:BrankasLounge(playerid, response, listitem, inputtext[])
{
    if(response)
    {
        switch(listitem)
        {
            case 0:
            {
                Dialog_Show(playerid, BrankasSambal, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas Pedagang", "Mohon ikuti format berikut\n[ambil] [jumlah] atau [depo] [jumlah]\nMasukkan tanpa tanda ][ pada kolom dibawah ini:", "Input", "Batal");
            }
            case 1:
            {
                Dialog_Show(playerid, BrankasBeras, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas Pedagang", "Mohon ikuti format berikut\n[ambil] [jumlah] atau [depo] [jumlah]\nMasukkan tanpa tanda ][ pada kolom dibawah ini:", "Input", "Batal");
            }
            case 2:
            {
                Dialog_Show(playerid, BrankasGula, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas Pedagang", "Mohon ikuti format berikut\n[ambil] [jumlah] atau [depo] [jumlah]\nMasukkan tanpa tanda ][ pada kolom dibawah ini:", "Input", "Batal");
            }
            case 3:
            {
                Dialog_Show(playerid, BrankasGaram, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas Pedagang", "Mohon ikuti format berikut\n[ambil] [jumlah] atau [depo] [jumlah]\nMasukkan tanpa tanda ][ pada kolom dibawah ini:", "Input", "Batal");
            }
            case 4:
            {
                Dialog_Show(playerid, BrankasIkan, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas Pedagang", "Mohon ikuti format berikut\n[ambil] [jumlah] atau [depo] [jumlah]\nMasukkan tanpa tanda ][ pada kolom dibawah ini:", "Input", "Batal");
            }
            case 5:
            {
                Dialog_Show(playerid, BrankasAyamFillet, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas Pedagang", "Mohon ikuti format berikut\n[ambil] [jumlah] atau [depo] [jumlah]\nMasukkan tanpa tanda ][ pada kolom dibawah ini:", "Input", "Batal");
            }
            case 6:
            {
                Dialog_Show(playerid, BrankasSusuOlahan, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas Pedagang", "Mohon ikuti format berikut\n[ambil] [jumlah] atau [depo] [jumlah]\nMasukkan tanpa tanda ][ pada kolom dibawah ini:", "Input", "Batal");
            }
            case 7:
            {
                Dialog_Show(playerid, BrankasAirMineral, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas Pedagang", "Mohon ikuti format berikut\n[ambil] [jumlah] atau [depo] [jumlah]\nMasukkan tanpa tanda ][ pada kolom dibawah ini:", "Input", "Batal");
            }
            case 8:
            {
                Dialog_Show(playerid, BrankasNasgor, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas Pedagang", "Mohon ikuti format berikut\n[ambil] [jumlah] atau [depo] [jumlah]\nMasukkan tanpa tanda ][ pada kolom dibawah ini:", "Input", "Batal");
            }
            case 9:
            {
                Dialog_Show(playerid, BrankasBakso, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas Pedagang", "Mohon ikuti format berikut\n[ambil] [jumlah] atau [depo] [jumlah]\nMasukkan tanpa tanda ][ pada kolom dibawah ini:", "Input", "Batal");
            }
            case 10:
            {
                Dialog_Show(playerid, BrankasNasiPecel, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas Pedagang", "Mohon ikuti format berikut\n[ambil] [jumlah] atau [depo] [jumlah]\nMasukkan tanpa tanda ][ pada kolom dibawah ini:", "Input", "Batal");
            }
            case 11:
            {
                Dialog_Show(playerid, BrankasBuburPedas, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas Pedagang", "Mohon ikuti format berikut\n[ambil] [jumlah] atau [depo] [jumlah]\nMasukkan tanpa tanda ][ pada kolom dibawah ini:", "Input", "Batal");
            }
            case 12:
            {
                Dialog_Show(playerid, BrankasSusuFresh, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas Pedagang", "Mohon ikuti format berikut\n[ambil] [jumlah] atau [depo] [jumlah]\nMasukkan tanpa tanda ][ pada kolom dibawah ini:", "Input", "Batal");
            }
            case 13:
            {
                Dialog_Show(playerid, BrankasEsTeh, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas Pedagang", "Mohon ikuti format berikut\n[ambil] [jumlah] atau [depo] [jumlah]\nMasukkan tanpa tanda ][ pada kolom dibawah ini:", "Input", "Batal");
            }
            case 14:
            {
                Dialog_Show(playerid, BrankasKopiKenangan, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas Pedagang", "Mohon ikuti format berikut\n[ambil] [jumlah] atau [depo] [jumlah]\nMasukkan tanpa tanda ][ pada kolom dibawah ini:", "Input", "Batal");
            }
            case 15:
            {
                Dialog_Show(playerid, BrankasCochoMatcha, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas Pedagang", "Mohon ikuti format berikut\n[ambil] [jumlah] atau [depo] [jumlah]\nMasukkan tanpa tanda ][ pada kolom dibawah ini:", "Input", "Batal");
            }
        }
    }
    else 
...
hook OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
    switch(dialogid)
    {
        ...
        {
            if(!response) return ShowTDN(playerid, NOTIFICATION_INFO, "Anda telah membatalkan pilihan");
            if(AccountData[playerid][pFaction] != FACTION_PEDAGANG) return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan anggota Resto Astral City!");
        ...
        case DIALOG_PEDAGANG_GARAGE:
        {
            ...
            switch(listitem)
            {
                ...
                {   
                    ...
                    ShowPlayerDialog(playerid, DIALOG_PEDAGANG_GARAGE_TAKEOUT, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Garasi Pedagang", lstr, "Pilih", "Batal");
                }
                ...
                {
                    ShowPlayerDialog(playerid, DIALOG_PEDAGANG_GARAGE_BUY, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Beli Kendaraan", 
                    "Model\tHarga\
                    \nRancher Resto\t$6000\
                ...
                case 3:// Hapus Kendaraan
                {
                    ...
                    if(rows)
                    {
                        ...
                        ShowPlayerDialog(playerid, DIALOG_PEDAGANG_GARAGE_DELETE, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Hapus Kendaraan", list, "Hapus", "Batal");
                    }
                    else 
                    {
                        PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
                        return Dialog_Show(playerid, ShowOnly, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Hapus Kendaraan", "Anda tidak memiliki kendaraan Pedagang", "Tutup", "");
                    }
                }
            }
        }
        ...
        {
            if(!response) return ShowTDN(playerid, NOTIFICATION_INFO, "Anda telah membatalkan pilihan");
            if(AccountData[playerid][pFaction] != FACTION_PEDAGANG) return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan anggota Pedagang Astral City!");
            if(AccountData[playerid][pFactionRank] < 5) return ShowTDN(playerid, NOTIFICATION_ERROR, "Minimal Rank Wakil CEO untuk akses Bos Desk!");

            if(isnull(inputtext)) return ShowPlayerDialog(playerid, DIALOG_RANK_SET_PEDAGANG, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Kelola Jabatan", \
            ...
            if(!IsNumeric(inputtext)) return ShowPlayerDialog(playerid, DIALOG_RANK_SET_PEDAGANG, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Kelola Jabatan", \
            ...
            if(strval(inputtext) < 1 || strval(inputtext) > AccountData[playerid][pFactionRank]) return ShowPlayerDialog(playerid, DIALOG_RANK_SET_PEDAGANG, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Kelola Jabatan", \
            ...
            if(cache_num_rows())
            {
                ...
                foreach(new i : Player)
                {
                    if(AccountData[i][IsLoggedIn] && AccountData[i][pSpawned] && pidrow == AccountData[i][pID])
                    {
                        ...
                        RefreshFactionMap(i);
                        ShowTDN(i, NOTIFICATION_WARNING, "Anda telah dikeluarkan dari faction Pedagang Astral City!");
                    }
                }
        ...
        case DIALOG_PEDSETRANK:
        {
            ...
            if(rows)
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_RANK_SET_PEDAGANG, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Kelola Jabatan", \
                "Silahkan pilih jabatan untuk ditetapkan (masukkan angka saja):\n\
                1. Magang\n\
                2. Junior\n\
                3. Senior\n\
