...
CMD:modif(playerid, params[])
{
    ...
    if(AccountData[playerid][pFaction] != FACTION_BENGKEL) return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan bagian dari Bengkel Astral City!");
    ...
    if(IsAModifArea(playerid))
    {
        ...
        if(AccountData[playerid][pFactionRank] < 3) // Dibawah Senior
        {
            ...
            ShowPlayerDialog(playerid, DIALOG_MODIF, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Modifikasi", minsty, "Pilih", "Batal");
        }
        else
        {
            format(minsty, sizeof(minsty), ""WHITE"Ganti Warna Kendaraan\n");
...
VarsGerbangBengkel()
{
    ...
    CreateDynamic3DTextLabel(string, -1, 195.813, -258.124, 1.819 + 0.3, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1, 0, 0, -1);
    CreateDynamic3DTextLabel(string, -1, 195.666, -252.537, 1.819 + 0.3, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1, 0, 0, -1);
    CreateDynamic3DTextLabel(string, -1, 195.719, -246.613, 1.819 + 0.3, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1, 0, 0, -1);
    CreateDynamic3DTextLabel(string, -1, 219.892, -250.868, 1.819 + 0.3, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1, 0, 0, -1);
    CreateDynamic3DTextLabel(string, -1, 219.845, -228.818, 1.819 + 0.3, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1, 0, 0, -1);
    CreateDynamicPickup(1239, 23, 195.813, -258.124, 1.819 + 0.1, -1, -1, -1, 10.0);
    CreateDynamicPickup(1239, 23, 195.666, -252.537, 1.819 + 0.1, -1, -1, -1, 10.0);
    CreateDynamicPickup(1239, 23, 195.719, -246.613, 1.819 + 0.1, -1, -1, -1, 10.0);
    CreateDynamicPickup(1239, 23, 219.892, -250.868, 1.819 + 0.1, -1, -1, -1, 10.0);
    CreateDynamicPickup(1239, 23, 219.845, -228.818, 1.819 + 0.1, -1, -1, -1, 10.0);

    Bengkel_Stuff[BengkelDuty] = CreateDynamicSphere(208.446, -268.516, 1.597, 1.5, -1, -1, -1);
    Bengkel_Stuff[BengkelDesk] = CreateDynamicSphere(207.757, -223.585, 9.198, 1.5, -1, -1, -1);
    Bengkel_Stuff[BengkelLocker] = CreateDynamicSphere(221.573, -223.561, 9.198, 1.5, -1, -1, -1);
    Bengkel_Stuff[BengkelGarage] = CreateDynamicSphere(208.121, -274.333, 1.578, 1.5, -1, -1, -1);
    Bengkel_Stuff[BengkelBrankas] = CreateDynamicSphere(219.196, -226.927, 9.198, 1.5, -1, -1, -1);
    Bengkel_Stuff[BengkelCraft] = CreateDynamicSphere(223.076, -266.585, 1.595, 1.5, -1, -1, -1);
    Bengkel_Stuff[BengkelModif][0] = CreateDynamicSphere(195.813, -258.124, 1.819, 2.5, -1, -1, -1);
    Bengkel_Stuff[BengkelModif][1] = CreateDynamicSphere(195.666, -252.537, 1.819, 2.5, -1, -1, -1);
    Bengkel_Stuff[BengkelModif][2] = CreateDynamicSphere(195.719, -246.613, 1.819, 2.5, -1, -1, -1);
    Bengkel_Stuff[BengkelModif][3] = CreateDynamicSphere(219.892, -250.868, 1.819, 2.5, -1, -1, -1);
    Bengkel_Stuff[BengkelModif][4] = CreateDynamicSphere(219.845, -228.818, 1.819, 2.5, -1, -1, -1);

    Bengkel_Stuff[bengkelgaragePos][0] = 208.121;
    Bengkel_Stuff[bengkelgaragePos][1] = -274.333;
    Bengkel_Stuff[bengkelgaragePos][2] = 1.578;
    
    Bengkel_Stuff[bengkelgarageSpawnPos][0] = 219.204;
    Bengkel_Stuff[bengkelgarageSpawnPos][1] = -275.724;
    Bengkel_Stuff[bengkelgarageSpawnPos][2] = 1.578;
    Bengkel_Stuff[bengkelgarageSpawnPos][3] = 91.235;
}
...
hook OnPlayerKeyStateChange(playerid, newkeys, oldkeys)
{
    if(newkeys & KEY_YES && GetPlayerState(playerid) == PLAYER_STATE_ONFOOT)
    {
        if(AccountData[playerid][pFaction] == FACTION_BENGKEL)
        {
            ...
            {
                ShowPlayerDialog(playerid, DIALOG_BENGKEL_LOCKER, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Locker Bengkel",
                "Baju Biasa\ 
            ...
            {
                if(AccountData[playerid][pFactionRank] < 1) return ShowTDN(playerid, NOTIFICATION_ERROR, "Minimal rank Magang Bengkel untuk dapat Craft!");
                
                ShowPlayerDialog(playerid, DIALOG_BENGKEL_BRANKASITEM, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Barang Bengkel", 
            ...
            if(IsPlayerInDynamicArea(playerid, Bengkel_Stuff[BengkelBrankas]) && AccountData[playerid][pDutyBengkel])
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_BENGVAULT, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Brankas Bengkel", 
            ...
            if(IsPlayerInDynamicArea(playerid, Bengkel_Stuff[BengkelDesk]))
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_BENGKEL_BOSDESK, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Bos Desk", 
                "Invite\
                \n"GRAY"Kelola Jabatan\
                \nKick\
                \n"GRAY"Lihat Anggota\
            ...
            {
                ShowPlayerDialog(playerid, DIALOG_BENGKEL_GARAGE, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Garasi Bengkel", 
                "Keluarkan Kendaraan\
...
hook OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
    ...
    switch(dialogid)
    {
        case DIALOG_BENGKEL_BOSDESK:
        {
            ...
            switch(listitem)
            {
                case 0: //invite
                {
                    ...
                    ShowPlayerDialog(playerid, DIALOG_BENGKEL_INVITE, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Invite", frmxt, "Pilih", "Batal");
                ...
                case 1: // Kelola Jabatan:
                {
                    ...
                    if (rows)
                    {
                        ...
                        ShowPlayerDialog(playerid, DIALOG_BENGKELSETRANK, DIALOG_STYLE_TABLIST_HEADERS, 
                            ""TTR"Astral City Roleplay "WHITE"- Set Jabatan", shstr, "Pilih", "Batal");
                    }
                    else
                    {
                        PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
                        return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, 
                            ""TTR"Astral City Roleplay "WHITE"- Set Jabatan", "Tidak ada Anggota Bengkel!", "Tutup", "");
                    }
                }
                case 2: // Kick Offline / Online
                {
                    ...
                    if (rows)
                    {
                        ...
                        ShowPlayerDialog(playerid, DIALOG_BENGKELKICKMEMBER, DIALOG_STYLE_TABLIST_HEADERS, 
                            ""TTR"Astral City Roleplay "WHITE"- Kick Anggota", shstr, "Kick", "Batal");
                    }
                    else
                    {
                        PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
                        return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, 
                            ""TTR"Astral City Roleplay "WHITE"- Kick Anggota", "Tidak ada Anggota Bengkel!", "Tutup", "");
                    }
                }
                case 3:// Anggota Online
                {
                    ...
                    format(lstr, sizeof lstr, "%s\n", lstr);
                    Dialog_Show(playerid, ShowOnly, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Anggota", lstr, "Close", "");
                }
                case 4:// Saldo Finansial
                {
                    new frmxt[158];
                    format(frmxt, sizeof(frmxt), "Perusahaan Bengkel Astral City saat ini memiliki saldo sebesar:\ 
                    \n"DARKGREEN"%s", FormatMoney(BengkelMoneyVault));
                    ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Bengkel Money", frmxt, "Tutup", "");
                }
                case 5:// Deposit Saldo
                {
                    ShowPlayerDialog(playerid, DIALOG_DEPOSIT_BENGKEL, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Bengkel Deposit", 
                    "Mohon masukkan nominal deposit untuk saldo perusahaan:", "Input", "Batal");
                }
                case 6:// Withdraw Saldo
                {
                    ShowPlayerDialog(playerid, DIALOG_WITHDRAW_BENGKEL, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Bengkel Withdraw",
        ...
        case DIALOG_DEPOSIT_BENGKEL:
        {
            ...
            ShowTDN(playerid, NOTIFICATION_SUKSES, sprintf("Anda berhasil deposit %s untuk Bengkel Astral City", FormatMoney(depocash)));
        }
        case DIALOG_WITHDRAW_BENGKEL:
        {
            ...
            ShowTDN(playerid, NOTIFICATION_SUKSES, sprintf("Anda berhasil withdraw %s dari Bengkel Astral City", FormatMoney(withdrawcash)));
        }
            ...
            switch(listitem)
            {
                case 0: //deposit
                {
                    ...
                    if(rows) 
                    {
                        ...
                        ShowPlayerDialog(playerid, DIALOG_BENGVAULT_DEPOSIT, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Brankas Bengkel", str, "Pilih", "Batal");
                    }
                    else 
                    {
                        AccountData[playerid][menuShowed] = false;
                        PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
                        return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Brankas Bengkel",
                ...
                case 1: //withdraw
                {
                    ...
                    if(cache_num_rows() > 0)
                    {
                        ...
                        ShowPlayerDialog(playerid, DIALOG_BENGVAULT_WITHDRAW, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Brankas Bengkel", str, "Pilih", "Batal");
                    }
                    else 
                    {
                        AccountData[playerid][menuShowed] = false;
        ...
        case DIALOG_BENGVAULT_DEPOSIT:
        {
            ...
            if(cache_num_rows() > 0)
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_BENGVAULT_IN, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas Bengkel", 
                shstr, "Input", "Batal");
            }
        }
        case DIALOG_BENGVAULT_IN:
        {
            if(BengProcessing[playerid])
                return ShowTDN(playerid, NOTIFICATION_WARNING, "Sedang memproses permintaan, tunggu sebentar!");
            BengProcessing[playerid] = true;

            if(!response)
            {
                BengProcessing[playerid] = false;
                AccountData[playerid][menuShowed] = false;
                return ShowTDN(playerid, NOTIFICATION_INFO, "Anda telah membatalkan pilihan");
            }
            ...
            if(isnull(inputtext) || !IsNumeric(inputtext))
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_BENGVAULT_IN, DIALOG_STYLE_INPUT, 
                    "TTR Astral City Roleplay - Brankas Bengkel", shstr, "Input", "Batal");
                BengProcessing[playerid] = false;
                return 1;
            }
            ...
            if(rows > 0)
            {
                mysql_format(g_SQL, invstr, sizeof(invstr), 
                    "UPDATE `bengkel_brankas` SET `Quantity` = `Quantity` + %d WHERE `PID` = 0 AND `Item`='%s'", 
                    quantity, FactionBrankas[playerid][factionBrankasTemp]);
                mysql_tquery(g_SQL, invstr, "OnBengkelDeposit", "i", playerid);
            }
            else
            {
                mysql_format(g_SQL, invstr, sizeof(invstr), 
                    "INSERT INTO `bengkel_brankas` SET `PID`=0, `Item`='%s', `Model`=%d, `Quantity`=%d", 
                    FactionBrankas[playerid][factionBrankasTemp], FactionBrankas[playerid][factionBrankasModel], quantity);
                mysql_tquery(g_SQL, invstr, "OnBengkelDeposit", "i", playerid);
            }
        ...
        case DIALOG_BENGVAULT_WITHDRAW:
        {
            ...
            if(cache_num_rows() > 0)
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_BENGVAULT_OUT, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas Bengkel",
                shstr, "Input", "Batal");
            }
            else 
            {
                AccountData[playerid][menuShowed] = false;
                ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Brankas Bengkel",
        ...
        {
            if(!response) return ShowTDN(playerid, NOTIFICATION_INFO, "Anda telah membatalkan pilihan");
            if(AccountData[playerid][pFaction] != FACTION_BENGKEL) return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan anggota Bengkel Astral City!");
            ...
            if(cache_num_rows())
            {
                ...
                foreach(new i : Player)
                {
                    if(AccountData[i][IsLoggedIn] && AccountData[i][pSpawned] && pidrow == AccountData[i][pID])
                    {
                        ...
                        RefreshFactionMap(i);
                        ShowTDN(i, NOTIFICATION_WARNING, "Anda telah dikeluarkan dari faction Bengkel Astral City!");
                    }
                }
        ...
        case DIALOG_BENGKELSETRANK:
        {
            ...
            if(rows)
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_RANK_SET_BENGKEL, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Kelola Jabatan",
        ...
        case DIALOG_RANK_SET_BENGKEL:
        {
            ...
            if (AccountData[playerid][pFaction] != FACTION_BENGKEL)
                return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan anggota Bengkel Astral City!");
            ...
            if (isnull(inputtext))
            {
                return ShowPlayerDialog(playerid, DIALOG_RANK_SET_BENGKEL, DIALOG_STYLE_INPUT,
                    ""TTR"Astral City Roleplay "WHITE"- Kelola Jabatan",
        ...
        case DIALOG_BENGKEL_BRANKASITEM:
        {
            ...
            switch(listitem)
            {
                case 0:// Repair Kits
                {
                    ...
                    ShowPlayerDialog(playerid, DIALOG_BENGKEL_BRANKASCONF, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Barang Bengkel", jskc, "Iya", "Batal");
                }
                case 1:// Tools
                {
                    static jskc[512];
        ...
        case DIALOG_BENGKEL_BRANKASREPAIRKIT:
        {
            ...
            {
                ShowPlayerDialog(playerid, DIALOG_BENGKEL_BRANKASREPAIRKIT, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas Bengkel", "Mohon ikuti sesuai format berikut:\n[ambil] [jumlah] atau [depo] [jumlah]\nMohon masukkan tanpa tanda ][ pada kolom dibawah ini:", "Input", "Batal");
                return 1;
            }
        ...
        case DIALOG_BENGKEL_BRANKASTOOLSKIT:
        {
            ...
            if(sscanf(inputtext, "s[128]d", option, amount))
            {
                ShowPlayerDialog(playerid, DIALOG_BENGKEL_BRANKASTOOLSKIT, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas Bengkel", "Mohon ikuti sesuai format berikut:\n[ambil] [jumlah] atau [depo] [jumlah]\nMohon masukkan tanpa tanda ][ pada kolom dibawah ini:", "Input", "Batal");
                return 1;
            }
            if(!strcmp(option, "ambil", true))
            {
        ...
        case DIALOG_BENGKEL_GARAGE:
        {
            ...
            switch(listitem)
            {
                case 0: //takeout
                {
                    ...
                    ShowPlayerDialog(playerid, DIALOG_BENGKELTAKEVEH, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Garasi Bengkel", list, "Pilih", "Batal");
                }
                case 1:// simpan kendaraan
                {
                    ...
                    if(!foundnearby) return ShowTDN(playerid, NOTIFICATION_ERROR, "Tidak ada kendaraan dari Bengkel Astral City milik anda di sekitar!");
                }
                case 2:// Beli Kendaraan
                {
                    ShowPlayerDialog(playerid, DIALOG_BENGKELBUYVEH, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Beli Kendaraan", 
                    "Model\tHarga\
                    \nTow Truck\t$5000\
                ...
                case 3:// Hapus Kendaraan
                {
                    ...
                    if(rows)
                    {
                        ...
                        ShowPlayerDialog(playerid, DIALOG_BENGKELDELCAR, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Hapus Kendaraan", list, "Hapus", "Batal");
                    }
                    else 
                    {
                        PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
                        return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Hapus Kendaraan", "Anda tidak memiliki kendaraan Bengkel!", "Tutup", "");
                    }
                }
            }
        }
        ...
        case DIALOG_BENGKEL_LOCKER:
        {
            ...
            switch(listitem)
            {
                ...
                case 1:
                {
                    ShowPlayerDialog(playerid, DIALOG_BENGKEL_CLOTHES, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Locker Bengkel", 
        ...
        case DIALOG_MODIF_COLOROPTION:
        {
            ...
            switch(listitem)
            {
                case 0:// Ganti Warna
                {
                    ShowPlayerDialog(playerid, DIALOG_MODIF_WARNA1, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Warna 1", color_string, "Input", "Batal");
                    // ShowPlayerDialog(playerid, DIALOG_MODIF_WARNA1, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Warna 1", "Mohon masukkan ID Color Dimulai Dari Angka 1 - 255\n"YELLOW"(Masukkan Dibawah Sini):", "Input", "Batal");
                }
                case 1:// Paintjob
                {
                    ShowPlayerDialog(playerid, DIALOG_MODIF_PAINTJOB, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Paint Job", "Mohon masukkan ID Paintjob kendaraan dikolom bawah ini:\n"YELLOW"(0 - 1 - 2 (3 Untuk Mengembalikan Ke Default))", "Input", "Batal");
                }
            }
        }
        case DIALOG_MODIF_WARNA1:
        {
            ...
            if(AccountData[playerid][pMechColor1] < 0 || AccountData[playerid][pMechColor1] > 255)
                return ShowPlayerDialog(playerid, DIALOG_MODIF_WARNA1, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Warna 1", "Mohon masukkan ID Color Dimulai Dari Angka 1 - 255\n"YELLOW"(Masukkan Dibawah Sini):", "Input", "Batal");
            
            ShowPlayerDialog(playerid, DIALOG_MODIF_WARNA2, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Warna 2", color_string, "Input", "Batal");
            // ShowPlayerDialog(playerid, DIALOG_MODIF_WARNA2, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Warna 2", "Mohon masukkan ID Color Dimulai Dari Angka 1 - 255\n"YELLOW"(Masukkan Dibawah Sini):", "Input", "Batal");
        }
        case DIALOG_MODIF_WARNA2:
        {
            ...
            if(AccountData[playerid][pMechColor2] < 0 || AccountData[playerid][pMechColor2] > 255)
                return ShowPlayerDialog(playerid, DIALOG_MODIF_WARNA2, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Warna 2", "Mohon masukkan ID Color Dimulai Dari Angka 1 - 255\n"YELLOW"(Masukkan Dibawah Sini):", "Input", "Batal");
        ...
        case DIALOG_MODIF_PAINTJOB:
        {
            ...
            if(AccountData[playerid][pMechColor1] < 0 || AccountData[playerid][pMechColor1] > 3)
                return ShowPlayerDialog(playerid, DIALOG_MODIF_PAINTJOB, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Paint Job", "ERROR: 0 - 1- 2 (3 untuk mengembalikan ke Semula)\n\nMohon masukkan ID Paintjob kendaraan dikolom bawah ini:", "Input", "Batal");
        ...
        case DIALOG_MODIF:
        {
            ...
            switch(listitem)
            {
                case 0:
				{
					ShowPlayerDialog(playerid, DIALOG_MODIF_COLOROPTION, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Ganti Warna Kendaraan", "Ganti Warna Kendaraan\nPaint Job Kendaraan", "Pilih", "Batal");
				}
				case 1:
				{
					ShowPlayerDialog(playerid, DIALOG_MODIF_VELG, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay"WHITE" - Velg", "Offroad\nMega\nWires\nTwist\nGrove\nImport\nAtomic\nAhab\nVirtual\nAccess\nTrance\nShadow\nRimshine\nClassic\nCutter\nSwitch\nDollar\n"RED"> Kembalikan Menjadi Standart", "Confirm", "back");
				}
				case 2:
				{
					ShowPlayerDialog(playerid, DIALOG_MODIF_SPOILER,DIALOG_STYLE_LIST,""TTR"Astral City Roleplay"WHITE" - Spoiler","Wheel Arc. Alien Spoiler\nWheel Arc. X-Flow Spoiler\nTransfender Win Spoiler\nTransfender Fury Spoiler\nTransfender Alpha Spoiler\nTransfender Pro Spoiler\nTransfender Champ Spoiler\nTransfender Race Spoiler\nTransfender Drag Spoiler\n"RED"> Kembalikan Menjadi Standart","Choose","back");
				}
				case 3:
				{
					ShowPlayerDialog(playerid, DIALOG_MODIF_HOODS, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay"WHITE" - Hoods", "Fury\nChamp\nRace\nWorx\n", "Confirm", "back");
				}
				case 4:
				{
					ShowPlayerDialog(playerid, DIALOG_MODIF_VENTS, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay"WHITE" - Venst", "Oval\nSquare\n", "Confirm", "back");
				}
				case 5:
				{
					ShowPlayerDialog(playerid, DIALOG_MODIF_LIGHTS, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay"WHITE" - Lights", "Round\nSquare\n", "Confirm", "back");
				}
				case 6:
				{
					ShowPlayerDialog(playerid, DIALOG_MODIF_EXHAUSTS, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay"WHITE" - Exhaust", "Wheel Arc. Alien exhaust\nWheel Arc. X-Flow exhaust\nLow Co. Chromer exhaust\nLow Co. Slamin exhaust\nTransfender Large exhaust\nTransfender Medium exhaust\nTransfender Small exhaust\nTransfender Twin exhaust\nTransfender Upswept exhaust\n"RED"> Kembalikan Menjadi Standart", "Confirm", "back");
				}
				case 7:
				{
					ShowPlayerDialog(playerid, DIALOG_MODIF_FRONT_BUMPERS, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay"WHITE" - Front Bumper", "Wheel Arc. Alien Bumper\nWheel Arc. X-Flow Bumper\nLow co. Chromer Bumper\nLow co. Slamin Bumper\n"RED"> Kembalikan Menjadi Standart", "Confirm", "back");
				}
				case 8:
				{
					ShowPlayerDialog(playerid, DIALOG_MODIF_REAR_BUMPERS, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay"WHITE" - Rear Bumper", "Wheel Arc. Alien Bumper\nWheel Arc. X-Flow Bumper\nLow co. Chromer Bumper\nLow co. Slamin Bumper\n"RED"> Kembalikan Menjadi Standart", "Confirm", "back");
				}
				case 9:
				{
					ShowPlayerDialog(playerid, DIALOG_MODIF_ROOFS, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay"WHITE" - Roofs", "Wheel Arc. Alien\nWheel Arc. X-Flow\nLow Co. Hardtop Roof\nLow Co. Softtop Roof\nTransfender Roof Scoop\n"RED"> Kembalikan Menjadi Standart", "Confirm", "back");
				}
				case 10:
				{
					ShowPlayerDialog(playerid, DIALOG_MODIF_SIDE_SKIRTS, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay"WHITE" - Side Kirts", "Wheel Arc. Alien Side Skirt\nWheel Arc. X-Flow Side Skirt\nLocos Chrome Strip\nLocos Chrome Flames\nLocos Chrome Arches \nLocos Chrome Trim\nLocos Wheelcovers\nTransfender Side Skirt\n"RED"> Kembalikan Menjadi Standart", "Confirm", "back");
				}
				case 11:
				{
					ShowPlayerDialog(playerid, DIALOG_MODIF_BULLBARS, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay"WHITE" - Bullbas", "Locos Chrome Grill\nLocos Chrome Bars\nLocos Chrome Lights \nLocos Chrome Bullbar", "Confirm", "back");
				}
				case 12:
				{
				...
				case 16:
				{
					ShowPlayerDialog(playerid, DIALOG_MODIF_NEON, DIALOG_STYLE_LIST,""TTR"Astral City Roleplay"WHITE" - Neon", 
                    "Merah\
                    \n"GRAY"Biru\
                    \nHijau\
                    \n"GRAY"Kuning\
                ...
                case 17:
                {
                    ShowPlayerDialog(playerid, DIALOG_UPGRADE, DIALOG_STYLE_TABLIST, ""TTR"Astral City Roleplay"WHITE"- Upgrade Kendaraan",
