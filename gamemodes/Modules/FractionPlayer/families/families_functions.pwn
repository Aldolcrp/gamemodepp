...
ShowFamiliesWeapon(playerid, famid)
{
    ...
    ShowPlayerDialog(playerid, DIALOG_FAMS_WEAPON, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Weapon Chest", shstr, "Pilih", "Batal");
    return 1;
}
...
CMD:f(playerid, params[])
{
    ...
    if(AccountData[playerid][pFamily] < 0)
        return ShowTDN(playerid, NOTIFICATION_ERROR, "You must in family member to use this command");
            
    if(sscanf(params,"s[128]",text))
        return ShowTDN(playerid, NOTIFICATION_SYNTAX, "/f(family) [text]");

    if(strval(text) > 128)
        return ShowTDN(playerid, NOTIFICATION_WARNING, "Text too long.");
	
	SendFamilyMessage(AccountData[playerid][pFamily], COLOR_PURPLE, ""GRAY"* %s %s: %s *", GetFamilyRank(playerid), AccountData[playerid][pName], params);
    return 1;
}
...
SendFamilyMessage(familyid, color, const str[], {Float,_}:...)
{
    ...
    if(args > 12)
    {
        ...
        foreach (new i : Player) if(AccountData[i][pFamily] == familyid) {
...
stock Families_GedelahFiture(playerid, targetid)
{
    ...
    Dialog_Show(playerid, FamiliesGeledah, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Geledah", str, "Select", "Close");
    return 1;
}
...
CMD:setfamilies(playerid, params[])
{
    ...
    SendClientMessageEx(playerid, -1, ""ASTRALCITYDOT"Anda menjadikan %s sebagai Families: %s dengan Rank: %s", ReturnName(otherid), FamData[famid][famName], GetFamilyRank(rank));
    SendClientMessageEx(otherid, -1, ""ASTRALCITYDOT"Admin %s menjadikan anda bagian dari Families: %s dengan Rank: %s", GetAdminName(playerid), FamData[famid][famName], GetFamilyRank(rank));
    return 1;
}
...
CMD:famcreate(playerid, params[])
{
    ...
    SendClientMessageEx(otherid, -1, ""ASTRALCITYDOT"Admin %s telah membuatkan Families: %s [%s], dan anda sebagai Leadernya", GetAdminName(playerid), name, type);
...
CMD:families(playerid, params[])
{
    ...
    if (cache_num_rows())
    {
        ...
        ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay"WHITE" - Fam List", list, "Tutup", "");
    }
    else
    {
        ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Official Family", "Tidak ada Families Official Kota untuk saat ini.", "Tutup", "");
    }
...
hook OnPlayerKeyStateChange(playerid, newkeys, oldkeys)
{
    if(newkeys & KEY_YES && GetPlayerState(playerid) == PLAYER_STATE_ONFOOT)
    {
        ...
        //     ShowPlayerDialog(playerid, DIALOG_BLACKMARKET, DIALOG_STYLE_TABLIST, ""TTR"Astral City Roleplay "WHITE"- BlackMarket Store",
        ...
        if(bosid > -1)
        {
            if(IsPlayerInRangeOfPoint(playerid, 2.0, FamData[bosid][famBosDeskPos][0], FamData[bosid][famBosDeskPos][1], FamData[bosid][famBosDeskPos][2]))
            {
                if(AccountData[playerid][pFamily] == bosid)
                {
                    ...
                    {
                        Dialog_Show(playerid, Bosdesk_Family, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Bos Desk", ""WHITE"Invite\n"ASTRALCITY_ARWIN"Kelola Jabatan\n"WHITE"Kick\n"WHITE"Cek Keuangan\n"ASTRALCITY_ARWIN"Taruh/Ambil Uang", "Pilih", "Batal");
                    }
        ...
        if(fid > -1)
        {
            if(IsPlayerInRangeOfPoint(playerid, 2.0, FamData[fid][famBrankasPos][0], FamData[fid][famBrankasPos][1], FamData[fid][famBrankasPos][2]))
            {
                if(AccountData[playerid][pFamily] == fid)
                {
                    ...
                    ShowPlayerDialog(playerid, DIALOG_FAMSBRANKAS, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Brankas Families",
    ...
    switch(dialogid)
    {
        ...
        case DIALOG_FAMSBRANKAS:
        {
            ...
            switch(listitem)
            {
                case 0: // Uang Merah
                {       
                    ShowPlayerDialog(playerid, DIALOG_FAMSRM_VAULT, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Red Money Storage",
                    "Cek Uang Merah\
                    \n"GRAY"Deposit\
                ...
                case 2: //ambil
                {
                    ...
                    ShowPlayerDialog(playerid, DIALOG_FAMSVAULT, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Brankas Families",
        ...
        case DIALOG_FAMSRM_VAULT:
        {
            ...
            switch(listitem)
            {
                case 0: // cek
                {
                    ...
                    ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Red Money", frmtmoney, "Tutup", "");
                }
                case 1: //
                {
                    ShowPlayerDialog(playerid, DIALOG_FAMSRM_DEPOSIT, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Deposit",
                    "Mohon masukkan jumlah uang merah yang ingin anda simpan dibrankas families:", "Input", "Batal");
                }
                case 2: //
                {
                    ShowPlayerDialog(playerid, DIALOG_FAMSRM_WITHDRAW, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Deposit",
        ...
        case DIALOG_FAMSTAKE_MONEY:
        {
            ...
            if(isnull(inputtext)) 
            {
                ...
                return ShowPlayerDialog(playerid, DIALOG_FAMSTAKE_MONEY, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Ambil Uang", frmxt, "Input", "Batal");
            }
        ...
        case DIALOG_FAMSTAKE_REDMONEY:
        {
            ...
            if(isnull(inputtext)) 
            {
                ...
                return ShowPlayerDialog(playerid, DIALOG_FAMSTAKE_REDMONEY, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Ambil Uang Merah", frmxt, "Input", "Batal");
            }
        ...
        {
            if(FamilyProcessing[playerid])
                return ShowTDN(playerid, NOTIFICATION_WARNING, "Sedang memproses permintaan, tunggu sebentar!");
            FamilyProcessing[playerid] = true;

            if(AccountData[playerid][pFamily] == -1)
            {
                FamilyProcessing[playerid] = false;
                AccountData[playerid][menuShowed] = false;
                return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan anggota Families!");
            }
            new famid = AccountData[playerid][pFamily];
            ...
            if(isnull(inputtext) || !IsNumeric(inputtext))
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_FAMSVAULT_IN, DIALOG_STYLE_INPUT, sprintf("Brankas %s", FamData[famid][famName]), shstr, "Input", "Batal");
                FamilyProcessing[playerid] = false;
                return 1;
            }
            ...
            if(rows > 0)
            {
                mysql_format(g_SQL, invstr, sizeof(invstr), "UPDATE `badside_brankas` SET `fItemQuantity` = `fItemQuantity` + %d WHERE `ID`=%d AND `fItemName`='%s'",
                    requested, AccountData[playerid][pFamily], FactionBrankas[playerid][factionBrankasTemp]);
                mysql_tquery(g_SQL, invstr, "OnBadsideDeposit", "i", playerid);
            }
            else 
            {
                mysql_format(g_SQL, invstr, sizeof(invstr), "INSERT INTO `badside_brankas` SET `ID`=%d, `fItemName`='%s', `fItemModel`=%d, `fItemQuantity`=%d",
                    AccountData[playerid][pFamily], FactionBrankas[playerid][factionBrankasTemp], FactionBrankas[playerid][factionBrankasModel], requested);
                mysql_tquery(g_SQL, invstr, "OnBadsideDeposit", "i", playerid);
            }
        ...
        case DIALOG_FAMILIESSETRANK:
        {
            ...
            if(rows)
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_RANK_SET_FAMILIES, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Set Jabatan", 
        ...
        case DIALOG_RANK_SET_FAMILIES:
        {
            ...
            if(isnull(inputtext)) return ShowPlayerDialog(playerid, DIALOG_RANK_SET_FAMILIES, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Kelola Jabatan", \
            "Error: Tidak dapat diisi kosong!\n\
            Silahkan pilih jabatan untuk ditetapkan (masukkan angka saja):\n\
            1. Relasi\n\
            2. Outsider\n\
            ...
            if(!IsNumeric(inputtext)) return ShowPlayerDialog(playerid, DIALOG_RANK_SET_FAMILIES, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Kelola Jabatan", \
            ...
            if(strval(inputtext) < 1 || strval(inputtext) > AccountData[playerid][pFamilyRank]) return ShowPlayerDialog(playerid, DIALOG_RANK_SET_FAMILIES, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Kelola Jabatan", \
        ...
        case DIALOG_FAMILY_PANEL:
        {
            ...
            switch(listitem)
            {
                ...
                case 9: // Ambil Uang Kotor
                {
                    ...
                    ShowPlayerDialog(playerid, DIALOG_FAMSTAKE_REDMONEY, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Ambil Uang Merah", frmxt, "Input", "Batal");
                ...
                case 10: // ambil uang
                {
                    ...
                    ShowPlayerDialog(playerid, DIALOG_FAMSTAKE_MONEY2, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Ambil Uang", frmxt, "Input", "Batal");
                    SetPVarInt(playerid, "TargetFamsID", targetid);
                }
                case 11: // Cek Senjata
                {
...
Dialog:Bosdesk_Family(playerid, response, listitem, inputtext[])
{
    ...
    switch(listitem)
    {
        case 0:// Invite
        {
            ...
            if(!count) return Dialog_Show(playerid, ShowOnly, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Invite", "Tidak ada orang yang dekat dengan anda!", "Close", "");
            Dialog_Show(playerid, FamiliesInvite, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Invite", sstr, "Pilih", "Batal");
        }
        case 1:// Kelola Jabatan Online / Offline
        {
            ...
            if(rows)
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_FAMILIESSETRANK, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Set Jabatan", shstr, "Pilih", "Batal");
            }
            else 
            {
                PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
                return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Set Jabatan", "Tidak ada Anggota Families!", "Tutup", "");
            }
        }
        case 2:// Offline Kick / Online
        {
            ...
            if(rows)
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_FAMILIESKICKMEMBER, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Kick Member", shstr, "Kick", "Batal");
            }
            else 
            {
                PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
                return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Kick Member", "Tidak ada Anggota Families!", "Tutup", "");
            }
        }
        case 3:// cek keuangan
        {
            ...
            Dialog_Show(playerid, ShowOnly, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Keuangan Families", sstr, "Tutup", "");
        }
        case 4:// Ambil atau taruh uang
        {
            ...
            Dialog_Show(playerid, FamiliesKeuangan, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Keuangan Families", sstr, "Input", "Batal");
        }
    }
    return 1;
}
...
Dialog:FamiliesGeledah(playerid, response, listitem, inputtext[])
{
    if(response)
    {
        ...
        if(InventoryData[targetid][listitem][invExists])
        {
            ...
            Dialog_Show(playerid, FamiliesTakeBarang, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Geledah", str, "Input", "Back");
        }
    }
    return 1;
}
