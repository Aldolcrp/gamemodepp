...
stock ShowWarung(playerid) 
{
	...
	if(id > -1)
    {
		if(IsPlayerInRangeOfPoint(playerid, 3.5, WarungData[id][warungPOS][0], WarungData[id][warungPOS][1], WarungData[id][warungPOS][2]))
		{
			...
			{
				PlayerTextDrawSetString(playerid, InventoryTD2[playerid][1], "Warung Umum");
				...
				PlayerTextDrawShow(playerid, LineInv2[playerid][0]);
				// ------------------- ITEM 2 ----------------- //
				...
				PlayerTextDrawShow(playerid, LineInv2[playerid][1]);
				// ------------------- ITEM 3 ----------------- //
				...
				PlayerTextDrawShow(playerid, LineInv2[playerid][2]);
				// ------------------- ITEM 4 ----------------- //
				...
				PlayerTextDrawShow(playerid, LineInv2[playerid][3]);
				// ------------------- ITEM 5 ----------------- //
				...
				PlayerTextDrawShow(playerid, LineInv2[playerid][4]);
				// ------------------- ITEM 6 ----------------- //
				...
				PlayerTextDrawShow(playerid, LineInv2[playerid][5]);
				// ------------------- ITEM 7 ----------------- //
				...
				PlayerTextDrawShow(playerid, LineInv2[playerid][6]);
				// ------------------- ITEM 8 ----------------- //
				...
				PlayerTextDrawShow(playerid, LineInv2[playerid][7]);
			}

			else if(WarungData[id][warungType] == 2) 
			{
				PlayerTextDrawSetString(playerid, InventoryTD2[playerid][1], "Warung Elektronik");
				// ------------------- ITEM 1 ----------------- //
				...
				PlayerTextDrawShow(playerid, LineInv2[playerid][4]);
				// ------------------- ITEM 6 ----------------- //
				format(WarungItemName[playerid][5], 32, "Race Tablet");
				WarungItemPrice[playerid][5] = 15000;

				PlayerTextDrawSetPreviewModel(playerid, PrevMod2[playerid][5], 19894);
				PlayerTextDrawShow(playerid,PrevMod2[playerid][5]);

				PlayerTextDrawSetString(playerid, NameInv2[playerid][5], "Race Tablet");
				PlayerTextDrawShow(playerid, NameInv2[playerid][5]);
				...
				PlayerTextDrawShow(playerid, LineInv2[playerid][5]);
				// ------------------- ITEM 7 ----------------- //
				format(WarungItemName[playerid][6], 32, "Senter");
				WarungItemPrice[playerid][6] = 5000;

				PlayerTextDrawSetPreviewModel(playerid, PrevMod2[playerid][6], 18641);
				PlayerTextDrawShow(playerid,PrevMod2[playerid][6]);

				PlayerTextDrawSetString(playerid, NameInv2[playerid][6], "Senter");
				PlayerTextDrawShow(playerid, NameInv2[playerid][6]);
	...
	switch(dialogid)
	{
		case DIALOG_WARUNG_ELEKTRONIK:
		{
			...
			switch(listitem)
			{
				...
				case 5: //Race tablet
				{
					...
					Inventory_Add(playerid, "Race Tablet", 19894);
					ShowItemBox(playerid, "Received 1x", "Race Tablet", 19894);
				}
			}
		}
		case DIALOG_WARUNG:
		{
			...
			switch(listitem)
			{
				case 0: // nasi uduk
				{
					ShowPlayerDialog(playerid, DIALOG_BUY_NASIUDUK, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Warung", 
					"Anda akan membeli nasi uduk seharga "GREEN"$250/pcs\n"YELLOW"(Masukkan berapa banyak yang ingin anda beli):", "Beli", "Batal");
				}
				case 1: //airmineral
				{
					ShowPlayerDialog(playerid, DIALOG_BUY_AIRMINERAL, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Warung", 
				...
				case 5: // Umpan
				{
					ShowPlayerDialog(playerid, DIALOG_BUY_UMPAN, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Warung", 
		...
		case DIALOG_BUY_NASIUDUK:
		{
			...
			if(isnull(inputtext))
			{
				return ShowPlayerDialog(playerid, DIALOG_BUY_NASIUDUK, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Warung",
		...
		case DIALOG_BUY_AIRMINERAL:
		{
			...
			if(isnull(inputtext))
			{
				return ShowPlayerDialog(playerid, DIALOG_BUY_AIRMINERAL, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Warung",
				"Error: Tidak dapat diisi kosong!\nAnda akan membeli air mineral seharga "GREEN"$200/pcs\n"YELLOW"(Masukkan berapa banyak yang ingin anda beli):", "Beli", "Batal");
			}
		...
		case DIALOG_BUY_UMPAN:
		{
			...
			if(isnull(inputtext))
			{
				return ShowPlayerDialog(playerid, DIALOG_BUY_UMPAN, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Warung",
