...
hook OnPlayerKeyStateChange(playerid, newkeys, oldkeys)
{
    if(newkeys & KEY_YES && GetPlayerState(playerid) == PLAYER_STATE_ONFOOT)
    {
        ...
        if(IsPlayerInRangeOfPoint(playerid, 2.0, -953.216, -494.536, 25.960))
        {
            ...
            Dialog_Show(playerid, DIALOG_URANIUM_PASS, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay - Uranium",
...
Dialog:DIALOG_URANIUM_PASS(playerid, response, listitem, inputtext[])
{
    ...
    ""TTR"Astral City Roleplay - Uranium", "Error: Tidak boleh kosong!\nMasukkan password:", "Input", "Batal");

    if(!strcmp(inputtext, UraniumPassword, true))
    {
        Dialog_Show(playerid, MixerUraniumConf, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay - Uranium",
