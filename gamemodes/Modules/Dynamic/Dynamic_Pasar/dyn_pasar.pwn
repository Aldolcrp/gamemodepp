...
Pasar_Refresh(id)
{
    if(id != -1)
    {
        ...
        {
            PasarData[id][pasarLabel] = CreateDynamic3DTextLabel(sprintf(""LIGHTGREY"[PID: %d]\n"WHITE"Tekan"ASTRALCITY_GREEN" [Y]"WHITE" untuk menjual Susu Olahan", id), -1, PasarData[id][pasarPos][0], PasarData[id][pasarPos][1], PasarData[id][pasarPos][2] + 0.3, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 0);
        }
        else if(PasarData[id][pasarType] == 2)
        {
            PasarData[id][pasarLabel] = CreateDynamic3DTextLabel(sprintf(""LIGHTGREY"[PID: %d]\n"WHITE"Tekan"ASTRALCITY_GREEN" [Y]"WHITE" untuk menjual Hasil Tambang", id), -1, PasarData[id][pasarPos][0], PasarData[id][pasarPos][1], PasarData[id][pasarPos][2] + 0.3, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 0);
        }
        else if(PasarData[id][pasarType] == 3)
        {
            PasarData[id][pasarLabel] = CreateDynamic3DTextLabel(sprintf(""LIGHTGREY"[PID: %d]\n"WHITE"Tekan"ASTRALCITY_GREEN" [Y]"WHITE" untuk menjual Kayu Kemas", id), -1, PasarData[id][pasarPos][0], PasarData[id][pasarPos][1], PasarData[id][pasarPos][2] + 0.3, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 0);
        }
        else if(PasarData[id][pasarType] == 4)
        {
            PasarData[id][pasarLabel] = CreateDynamic3DTextLabel(sprintf(""LIGHTGREY"[PID: %d]\n"WHITE"Tekan"ASTRALCITY_GREEN" [Y]"WHITE" untuk menjual Ayam Kemas", id), -1, PasarData[id][pasarPos][0], PasarData[id][pasarPos][1], PasarData[id][pasarPos][2] + 0.3, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 0);
        }
        else if(PasarData[id][pasarType] == 5)
        {
            PasarData[id][pasarLabel] = CreateDynamic3DTextLabel(sprintf(""LIGHTGREY"[PID: %d]\n"WHITE"Tekan"ASTRALCITY_GREEN" [Y]"WHITE" untuk menjual Hasil Daur", id), -1, PasarData[id][pasarPos][0], PasarData[id][pasarPos][1], PasarData[id][pasarPos][2] + 0.3, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 0);
        }
        else if(PasarData[id][pasarType] == 6)
        {
            PasarData[id][pasarLabel] = CreateDynamic3DTextLabel(sprintf(""LIGHTGREY"[PID: %d]\n"WHITE"Tekan"ASTRALCITY_GREEN" [Y]"WHITE" untuk menjual/membeli Hasil Tani", id), -1, PasarData[id][pasarPos][0], PasarData[id][pasarPos][1], PasarData[id][pasarPos][2] + 0.3, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 0);
        }
        else if(PasarData[id][pasarType] == 7)
        {
            PasarData[id][pasarLabel] = CreateDynamic3DTextLabel(sprintf(""LIGHTGREY"[PID: %d]\n"WHITE"Tekan"ASTRALCITY_GREEN" [Y]"WHITE" untuk menjual Pakaian", id), -1, PasarData[id][pasarPos][0], PasarData[id][pasarPos][1], PasarData[id][pasarPos][2] + 0.3, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 0);
        }
        else if(PasarData[id][pasarType] == 8)
        {
            PasarData[id][pasarLabel] = CreateDynamic3DTextLabel(sprintf(""LIGHTGREY"[PID: %d]\n"WHITE"Tekan"ASTRALCITY_GREEN" [Y]"WHITE" untuk menjual GAS", id), -1, PasarData[id][pasarPos][0], PasarData[id][pasarPos][1], PasarData[id][pasarPos][2] + 0.3, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 0);
        }
        else if(PasarData[id][pasarType] == 9)
        {
            PasarData[id][pasarLabel] = CreateDynamic3DTextLabel(sprintf(""LIGHTGREY"[PID: %d]\n"WHITE"Tekan"ASTRALCITY_GREEN" [Y]"WHITE" untuk menjual Ikan Nelayan", id), -1, PasarData[id][pasarPos][0], PasarData[id][pasarPos][1], PasarData[id][pasarPos][2] + 0.3, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 0);
        }
    }
    return 1;
}
    ...
    if(newkeys & KEY_YES && GetPlayerState(playerid) == PLAYER_STATE_ONFOOT)
    {
        ...
        foreach(new id : PASAR)
        {
            if(IsPlayerInRangeOfPoint(playerid, 2.0, PasarData[id][pasarPos][0], PasarData[id][pasarPos][1], PasarData[id][pasarPos][2]))
            {
                ...
                if(PasarData[id][pasarType] == 1)
                {
                    Dialog_Show(playerid, Pasar_HasilSusu, DIALOG_STYLE_TABLIST, ""TTR"Astral City Roleplay "WHITE"- Jual Hasil Kayu",
                    "Susu Olahan\t"GREEN"%s"ARWIN1"/pcs", "Pilih", "Batal", FormatMoney(SusuOlahPrice));
                }
                else if(PasarData[id][pasarType] == 2)
                {
                    Dialog_Show(playerid, Pasar_HasilTambang, DIALOG_STYLE_TABLIST, ""TTR"Astral City Roleplay "WHITE"- Jual Hasil Tambang",
                ...
                {
                    Dialog_Show(playerid, Pasar_HasilKayu, DIALOG_STYLE_TABLIST, ""TTR"Astral City Roleplay "WHITE"- Jual Hasil Kayu",
                    "Kayu Kemas\t"GREEN"%s"ARWIN1"/pcs", "Pilih", "Batal", FormatMoney(KayuKemasPrice));
                }
                else if(PasarData[id][pasarType] == 4)
                {
                    Dialog_Show(playerid, Pasar_HasilAyam, DIALOG_STYLE_TABLIST, ""TTR"Astral City Roleplay "WHITE"- Jual Hasil Ayam",
                    "Ayam Kemas\t"GREEN"%s"ARWIN1"/pcs", "Pilih", "Batal", FormatMoney(AyamKemasPrice));             
                }
                else if(PasarData[id][pasarType] == 5)
                {
                    Dialog_Show(playerid, Pasar_HasilDaur, DIALOG_STYLE_TABLIST, ""TTR"Astral City Roleplay "WHITE"- Jual Hasil Recycler",
                ...
                {
                    Dialog_Show(playerid, Pasar_HasilPakaian, DIALOG_STYLE_TABLIST, ""TTR"Astral City Roleplay "WHITE"- Jual Hasil Pakaian",
                    "Pakaian\t"GREEN"%s"ARWIN1"/pcs", "Pilih", "Batal", FormatMoney(PakaianPrice));                
                }
                else if(PasarData[id][pasarType] == 8)
                {
                    Dialog_Show(playerid, Pasar_HasilMinyak, DIALOG_STYLE_TABLIST, ""TTR"Astral City Roleplay "WHITE"- Jual Hasil Minyak",
