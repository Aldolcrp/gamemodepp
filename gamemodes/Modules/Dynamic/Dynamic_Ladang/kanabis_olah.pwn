    ...
    if(newkeys & KEY_YES && GetPlayerState(playerid) == PLAYER_STATE_ONFOOT)
    {
        if(IsPlayerInDynamicArea(playerid, kanabisOlah))
        {
            ...
            if(count >= 3)
            {
                ...
                Dialog_Show(playerid, DIALOG_MARJUN_PAS, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay - Marijuana",
...
Dialog:DIALOG_MARJUN_PAS(playerid, response, listitem, inputtext[])
{
    ...
    ""TTR"Astral City Roleplay - Marijuana", "Error: Tidak boleh kosong!\nMasukkan password:", "Input", "Batal");
