...
/*CMD:gotodoor(playerid, params[])
{
	...
	Dialog_Show(playerid, DIALOG_GOTO_DOOR, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Dynamic Door", shstr, "Select", "Cancel");
	return 1;
}
...
CMD:doorlist(playerid, params[])
{
    ...
    ShowPlayerDialog(playerid, DIALOG_DOORLIST, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay - "WHITE"Daftar Door Kota", dialogStr, "Tutup", "");
    return 1;
}
