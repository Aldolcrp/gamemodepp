...
stock LoadVarsRongsok()
{
    ...
    CreateDynamic3DTextLabel(""YELLOW"[Rongsokan]\n\n"WHITE"Botol "ASTRALCITY_GREEN"$4/botol\n\n"ASTRALCITY_GREEN"[Y] "WHITE"Menjual Botol", -1, 2183.0188, -1986.7108, 13.1645+1.4, 6.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1);
}
