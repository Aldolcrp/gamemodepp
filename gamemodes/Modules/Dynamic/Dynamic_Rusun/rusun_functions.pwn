...
RemainingTime(playerid)
{
    ...
    if(rsid != -1)
    {
        ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, sprintf(""TTR"Astral City Roleplay "WHITE"- %s", RusunData[rsid][rusunName]),
        shstr, "Tutup", "");
    }
    return 1;
}
...
hook OnPlayerKeyStateChange(playerid, newkeys, oldkeys)
{
    if(newkeys & KEY_YES && GetPlayerState(playerid) == PLAYER_STATE_ONFOOT)
    {
        ...
        {
            ShowPlayerDialog(playerid, DIALOG_RUSUN_BRANKAS, DIALOG_STYLE_LIST, sprintf(""TTR"Astral City Roleplay "WHITE"- %s", RusunData[AccountData[playerid][pInRusun]][rusunName]),
            "Undang\
            \n"GRAY"Pakaian\
            \nMembuang Pakaian\
        ...
        if(rsid != -1)
        {
            if(RusunData[rsid][rusunOwnerID] != 0)
            {
                ...
                else
                {
                    ...
                    ShowPlayerDialog(playerid, DIALOG_RUSUN_OWNED, DIALOG_STYLE_LIST, sprintf(""TTR"Astral City Roleplay "WHITE"- %s", RusunData[rsid][rusunName]), 
                    "Masuk\
            ...
            {
                AccountData[playerid][pInRusun] = rsid;
                format(srss, sizeof(srss), "Sewa\t"GREEN"%s / 30 Hari", FormatMoney(RusunData[rsid][rusunPrice]));
                ShowPlayerDialog(playerid, DIALOG_RUSUN, DIALOG_STYLE_TABLIST, sprintf(""TTR"Astral City Roleplay "WHITE"- %s", RusunData[rsid][rusunName]),
                srss, "Pilih", "Batal");
            }
        }
    }
...
hook OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
    ...
    else if(dialogid == DIALOG_RUSUN_BRANKAS)
    {
        ...
        switch(listitem)
        {
            case 0:
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_RUSUN_INVITE, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Undang Teman", frmxt, "Pilih", "Batal");
            }
            case 1:
            {
            ...
            case 3:
            {
                ShowPlayerDialog(playerid, DIALOG_RUSUN_BROPTION, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Brankas",
        ...
        switch(listitem)
        {
            case 0: //deposit
            {
                ...
                if(cache_num_rows() > 0)
                {
                    ...
                    ShowPlayerDialog(playerid, DIALOG_RUSUNVAULT_DEPOSIT, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Brankas", str, "Pilih", "Batal");
                }
                else 
                {
                    PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
                    return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Brankas",
            ...
            case 1: //withdraw
            {
                ...
                if(cache_num_rows() > 0)
                {
                    ...
                    ShowPlayerDialog(playerid, DIALOG_RUSUNVAULT_WITHDRAW, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Brankas", str, "Pilih", "Batal");
                }
                else 
                {
                    return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Brankas",
    ...
    else if(dialogid == DIALOG_RUSUN_INVITE)
    {
        ...
        if(rsid > -1)
        {
            ...
            ShowPlayerDialog(targetid, DIALOG_RUSUN_INVITECONF, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Undang Teman",
    ...
    else if(dialogid == DIALOG_RUSUNVAULT_DEPOSIT)
    {
        ...
        if(cache_num_rows() > 0)
        {
            if(listitem >= 0 && listitem < cache_num_rows())
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_RUSUNVAULT_IN, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas",
                shstr, "Input", "Batal");
            }
        }
    }
    else if(dialogid == DIALOG_RUSUNVAULT_IN)
    {
        ...
        if(isnull(inputtext) || !IsNumeric(inputtext))
        {
            format(shstr, sizeof(shstr), "Anda akan menyimpan item:\nNama: %s\nJumlah di tas: %d\nMohon masukkan jumlah valid!",
                RusunBrankas[playerid][rusunbrankasTemp], RusunBrankas[playerid][rusunbrankasQuant]);
            ShowPlayerDialog(playerid, DIALOG_RUSUNVAULT_IN, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas", shstr, "Input", "Batal");
            RusunProcessing[playerid] = false;
            return 1;
        }

        new requested = strval(inputtext);
        new avail = Inventory_Count(playerid, RusunBrankas[playerid][rusunbrankasTemp]);
        ...
        if(AccountData[playerid][pRusunCapacity] + requested > 80)
        {
            RusunProcessing[playerid] = false;
            return ShowTDN(playerid, NOTIFICATION_ERROR, "Brankas rusun anda telah penuh!");
        }

        Inventory_Remove(playerid, RusunBrankas[playerid][rusunbrankasTemp], requested);
        ShowItemBox(playerid, sprintf("Removed %dx", requested), RusunBrankas[playerid][rusunbrankasTemp], RusunBrankas[playerid][rusunbrankasModel]);
        AddCapacityRusun(playerid, RusunBrankas[playerid][rusunbrankasTemp], requested);

        new invstr[1024];
        mysql_format(g_SQL, invstr, sizeof(invstr), "INSERT INTO `player_rusunstorage` (`ID`,`rsItemName`,`rsItemModel`,`rsItemQuantity`) VALUES(%d,'%e',%d,%d) ON DUPLICATE KEY UPDATE `rsItemQuantity` = `rsItemQuantity` + %d", AccountData[playerid][pID], RusunBrankas[playerid][rusunbrankasTemp], RusunBrankas[playerid][rusunbrankasModel], requested, requested);
    ...
    else if(dialogid == DIALOG_RUSUNVAULT_WITHDRAW)
    {
        ...
        if(cache_num_rows() > 0)
        {
            if(listitem >= 0 && listitem < cache_num_rows())
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_RUSUNVAULT_OUT, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Brankas",
                shstr, "Input", "Batal");
            }
        }
    }
