Dialog:EditingVehObject(playerid, response, listitem, inputtext[])
{
    if(response)
    {
        ...
        else
        {
            ...
            {
                Dialog_Show(playerid, VACCSE, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Edit Component", "Position\nPosition (Manual)\nChange Color\nRemove Modification\nSave", "Select", "Back");
            }
            else if(VehicleObjects[vehicleid][slot][vehObjectType] == OBJECT_TYPE_TEXT)
            {
                Dialog_Show(playerid, VACCSE1, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Edit Component", "Position\nPosition (Manual)\nText Name\nText Size\nText Font\nText Color\nRemove Modification\nSave", "Select", "Back");
            }
            else if(VehicleObjects[vehicleid][slot][vehObjectType] == OBJECT_TYPE_LIGHT)
            {
               Dialog_Show(playerid, VACCSE2, DIALOG_STYLE_LIST, ""TTR"Astral City Roleplay "WHITE"- Edit Component", "Position\nPosition (Manual)\nRemove Modification\nSave", "Select", "Back");
            }
        }
    }
    return 1;
...
Dialog:MODSHOP_CUSTOM(playerid, response, listitem, inputtext[])
{
    if(response)
    {
        ...
        if(isnull(inputtext)) return Dialog_Show(playerid, MODSHOP_CUSTOM, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Modshop",
        ...
        if(!IsNumeric(inputtext)) return Dialog_Show(playerid, MODSHOP_CUSTOM, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Modshop",
