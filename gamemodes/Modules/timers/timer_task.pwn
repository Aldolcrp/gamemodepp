...
FUNC:: OnPDelayUpdate(playerid)
{
	...
	if(AccountData[playerid][pGunLic] > 0)
	{
		if(AccountData[playerid][pGunLicTime] != 0 && AccountData[playerid][pGunLicTime] <= gettime())
		{
			...
			Info(playerid, "Masa berlaku Lisensi Senjata anda sudah habis, silakan perpanjang ke Kepolisian Astral City!");
		}
	}
	if(AccountData[playerid][pHuntingLic] > 0)
	{
		if(AccountData[playerid][pHuntingLicTime] != 0 && AccountData[playerid][pHuntingLicTime] <= gettime())
		{
			...
			Info(playerid, "Masa berlaku Lisensi Hunting anda sudah habis, silakan perpanjang ke Pemerintahan Astral City!");
		}
	}
	// Sim Expired
	if(AccountData[playerid][pSimA] > 0)
	{
		if(AccountData[playerid][pSimATime] != 0 && AccountData[playerid][pSimATime] <= gettime())
		{
			...
			SendClientMessageEx(playerid, -1, ""YELLOW"INFORMATION:"WHITE" Masa Waktu Sim A Anda sudah tidak berlaku, anda bisa memperpanjangnya di Kepolisian Astral City");
		}
	}
	if(AccountData[playerid][pSimB] > 0)
	{
		if(AccountData[playerid][pSimBTime] != 0 && AccountData[playerid][pSimBTime] <= gettime())
		{
			...
			SendClientMessageEx(playerid, -1, ""YELLOW"INFORMATION:"WHITE" Masa Waktu Sim B Anda sudah tidak berlaku, anda bisa memperpanjangnya di Kepolisian Astral City");
		}
	}
	if(AccountData[playerid][pSimC] > 0)
	{
		if(AccountData[playerid][pSimCTime] != 0 && AccountData[playerid][pSimCTime] <= gettime())
		{
			...
			SendClientMessageEx(playerid, -1, ""YELLOW"INFORMATION:"WHITE" Masa Waktu Sim C Anda sudah tidak berlaku, anda bisa memperpanjangnya di Kepolisian Astral City");
		}
	}
	...
	if(AccountData[playerid][pSKS] > 0)
	{
		...
		{
			Dialog_Show(playerid, ShowOnly, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Surat Keterangan Sehat", "Masa aktif Surat Keterangan Sehat Anda Sudah Habis\
			\nAnda diharuskan untuk memperpanjang ke Mitra EMS Astral City Jika berkenan", "Tutup", "");
	...
	if(AccountData[playerid][pSKCK] > 0)
	{
		...
		{
			Dialog_Show(playerid, ShowOnly, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Surat Keterangan Cacatan Kepolisian", "Masa aktif Surat Keterangan Cacatan Kepolisian/SKCK Anda Sudah Habis\
			\nAnda diharuskan untuk memperpanjang ke Kepolisian Astral City Jika berkenan", "Tutup", "");
	...
	if(AccountData[playerid][pBPJS] > 0)
	{
		...
		{
			Dialog_Show(playerid, ShowOnly, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Kartu Astral City Sehat", "Masa aktif Kartu Astral City Sehat/BPJS Anda Sudah Habis\
			\nAnda diharuskan untuk memperpanjang ke Mitra EMS Astral City Jika berkenan", "Tutup", "");
