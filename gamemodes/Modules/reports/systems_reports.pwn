...
hook OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
    if(dialogid == DIALOG_REPORTS)
    {
        if(response)
        {
            ...
            ShowPlayerDialog(playerid, DIALOG_REPORTSREPLY, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Answer Report", shstr, "Answer", "Cancel");
    ...
    else if(dialogid == DIALOG_REPORTSREPLY)
    {
        if(response)
        {
            ...
            if(isnull(inputtext))
            {
                ...
                ReturnName(ReportData[reportid][rPlayer]), AccountData[ReportData[reportid][rPlayer]][pUCP], ReportData[reportid][rPlayer], frmxt);
                return ShowPlayerDialog(playerid, DIALOG_REPORTSREPLY, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Answer Report", shstr, "Answer", "Cancel");
            }
