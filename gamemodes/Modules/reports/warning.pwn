...
stock ShowPlayerWarning(playerid, targetid)
{
    ...
    if(cache_num_rows())
    {
        ...
        ShowPlayerDialog(targetid, DIALOG_UNUSED, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Riwayat Peringatan", shstr, "Tutup", "");
    }
    else
    {
...
CMD:ajail(playerid, params[])
{
    ...
    if(count == 0)
		...
		ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Player Jail", list, "Close", "");
	return 1;
}
