...
jobs_mixer_create_gtd()
{
    ...
    TextDrawTextSize(jobs::Gmixer[0], 251.000, 87.000);
    ...
    jobs::Gmixer[1] = TextDrawCreate(198.000, 198.000, "LD_SPAC:white");
    ...
    jobs::Gmixer[2] = TextDrawCreate(202.000, 220.000, "LD_SPAC:white");
    TextDrawTextSize(jobs::Gmixer[2], 45.000, 18.000);
    TextDrawAlignment(jobs::Gmixer[2], 1);
    TextDrawColor(jobs::Gmixer[2], -1199174657);
    ...
    jobs::Gmixer[3] = TextDrawCreate(252.000, 220.000, "LD_SPAC:white");
    TextDrawTextSize(jobs::Gmixer[3], 45.000, 18.000);
    TextDrawAlignment(jobs::Gmixer[3], 1);
    TextDrawColor(jobs::Gmixer[3], -1199174657);
    ...
    jobs::Gmixer[4] = TextDrawCreate(301.000, 220.000, "LD_SPAC:white");
    TextDrawTextSize(jobs::Gmixer[4], 45.000, 18.000);
    TextDrawAlignment(jobs::Gmixer[4], 1);
    TextDrawColor(jobs::Gmixer[4], -1199174657);
    ...
    jobs::Gmixer[5] = TextDrawCreate(351.000, 220.000, "LD_SPAC:white");
    TextDrawTextSize(jobs::Gmixer[5], 45.000, 18.000);
    TextDrawAlignment(jobs::Gmixer[5], 1);
    TextDrawColor(jobs::Gmixer[5], -1199174657);
    ...
    jobs::Gmixer[6] = TextDrawCreate(400.000, 220.000, "LD_SPAC:white");
    TextDrawTextSize(jobs::Gmixer[6], 45.000, 18.000);
    TextDrawAlignment(jobs::Gmixer[6], 1);
    TextDrawColor(jobs::Gmixer[6], -1199174657);
    ...
    jobs::Gmixer[7] = TextDrawCreate(279.000, 252.000, "LD_SPAC:white");
    TextDrawTextSize(jobs::Gmixer[7], 91.000, 18.000);
    TextDrawAlignment(jobs::Gmixer[7], 1);
    TextDrawColor(jobs::Gmixer[7], -2147483393);
    ...
    TextDrawLetterSize(jobs::Gmixer[9], 0.259, 1.299);
    ...
    TextDrawLetterSize(jobs::Gmixer[10], 0.259, 1.299);
    ...
    TextDrawLetterSize(jobs::Gmixer[11], 0.259, 1.299);
    ...
    TextDrawLetterSize(jobs::Gmixer[12], 0.259, 1.299);
    ...
    TextDrawLetterSize(jobs::Gmixer[13], 0.259, 1.299);
    ...
    jobs::Gmixer[14] = TextDrawCreate(322.000, 188.000, "Batching");
    ...
    jobs::GBMixer[0] = TextDrawCreate(514.000, 169.000, "LD_SPAC:white");
    TextDrawTextSize(jobs::GBMixer[0], 62.000, 9.000);
    ...
    jobs::GBMixer[1] = TextDrawCreate(515.000, 170.000, "LD_SPAC:white");
    TextDrawTextSize(jobs::GBMixer[1], 60.000, 7.000);
    TextDrawAlignment(jobs::GBMixer[1], 1);
    TextDrawColor(jobs::GBMixer[1], -2139062017);
    ...
    jobs::GBMixer[2] = TextDrawCreate(530.000, 156.000, "SLUMP");
    TextDrawLetterSize(jobs::GBMixer[2], 0.300, 1.199);
    TextDrawAlignment(jobs::GBMixer[2], 1);
    TextDrawColor(jobs::GBMixer[2], -1);
    TextDrawSetShadow(jobs::GBMixer[2], 1);
    TextDrawSetOutline(jobs::GBMixer[2], 1);
...
{
    jobs::Pmixer[playerid][0] = CreatePlayerTextDraw(playerid, 226.000, 155.000, "100");
    PlayerTextDrawLetterSize(playerid, jobs::Pmixer[playerid][0], 0.259, 1.299);
    ...
    PlayerTextDrawColor(playerid, jobs::Pmixer[playerid][0], -2147483393);
    ...
    jobs::Pmixer[playerid][1] = CreatePlayerTextDraw(playerid, 270.000, 155.000, "100");
    PlayerTextDrawLetterSize(playerid, jobs::Pmixer[playerid][1], 0.259, 1.299);
    ...
    PlayerTextDrawColor(playerid, jobs::Pmixer[playerid][1], -2147483393);
    ...
    jobs::Pmixer[playerid][2] = CreatePlayerTextDraw(playerid, 320.000, 155.000, "100");
    PlayerTextDrawLetterSize(playerid, jobs::Pmixer[playerid][2], 0.259, 1.299);
    ...
    PlayerTextDrawColor(playerid, jobs::Pmixer[playerid][2], -2147483393);
    ...
    jobs::Pmixer[playerid][3] = CreatePlayerTextDraw(playerid, 374.000, 155.000, "100");
    PlayerTextDrawLetterSize(playerid, jobs::Pmixer[playerid][3], 0.259, 1.299);
    ...
    PlayerTextDrawColor(playerid, jobs::Pmixer[playerid][3], -2147483393);
    ...
    jobs::Pmixer[playerid][4] = CreatePlayerTextDraw(playerid, 423.000, 155.000, "100");
    PlayerTextDrawLetterSize(playerid, jobs::Pmixer[playerid][4], 0.259, 1.299);
    ...
    PlayerTextDrawColor(playerid, jobs::Pmixer[playerid][4], -2147483393);
    ...
    jobs::Pmixer[playerid][5] = CreatePlayerTextDraw(playerid, 225.000, 223.000, "0");
    PlayerTextDrawLetterSize(playerid, jobs::Pmixer[playerid][5], 0.259, 1.299);
    ...
    jobs::Pmixer[playerid][6] = CreatePlayerTextDraw(playerid, 275.000, 223.000, "0");
    PlayerTextDrawLetterSize(playerid, jobs::Pmixer[playerid][6], 0.259, 1.299);
    ...
    jobs::Pmixer[playerid][7] = CreatePlayerTextDraw(playerid, 324.000, 223.000, "0");
    PlayerTextDrawLetterSize(playerid, jobs::Pmixer[playerid][7], 0.259, 1.299);
    ...
    jobs::Pmixer[playerid][8] = CreatePlayerTextDraw(playerid, 374.000, 223.000, "0");
    PlayerTextDrawLetterSize(playerid, jobs::Pmixer[playerid][8], 0.259, 1.299);
    ...
    jobs::Pmixer[playerid][9] = CreatePlayerTextDraw(playerid, 423.000, 223.000, "0");
    PlayerTextDrawLetterSize(playerid, jobs::Pmixer[playerid][9], 0.259, 1.299);
    ...
    jobs::Pmixer[playerid][10] = CreatePlayerTextDraw(playerid, 324.000, 255.000, "CONFIRM");
    PlayerTextDrawLetterSize(playerid, jobs::Pmixer[playerid][10], 0.259, 1.299);
    ...
    PlayerTextDrawSetShadow(playerid, jobs::Pmixer[playerid][10], 1);
    PlayerTextDrawSetOutline(playerid, jobs::Pmixer[playerid][10], 1);
    ...
    jobs::PBMixer[playerid] = CreatePlayerTextDraw(playerid, 515.000, 170.000, "LD_SPAC:white");
    PlayerTextDrawTextSize(playerid, jobs::PBMixer[playerid], 60.000, 7.000);
...
FUNC::jobs_mixer_select_case(playerid, cases)
{
    ...
    ShowPlayerDialog(playerid, DIALOG_MIXER, DIALOG_STYLE_INPUT, "{FFB6C1}Aeters Roleplay{FFFFFF} - Batching Plant", "Mohon masukkan jumlah takaran yang akan ditetapkan:", "Set", "Batal");
...
stock slumpminus(playerid)
{
    ...
    new Float: progressvalue; 
    progressvalue = jobs::mixer[playerid][mixerSlump]*60/100;
    PlayerTextDrawTextSize(playerid, jobs::PBMixer[playerid], progressvalue, 7.0);
    PlayerTextDrawShow(playerid, jobs::PBMixer[playerid]);
    return 1;
}
...
jobs_mixer_label()
{
    ...
    CreateDynamic3DTextLabel(""LIGHT_GREEN"[Y] {FFFFFF}mulai pekerjaan supir mixer", X11_PINK, 641.2187,1238.3390,11.6796, 15.0);
    
    //point batching
    CreateDynamic3DTextLabel(""LIGHT_GREEN"[klakson] {FFFFFF}minta beton dituang", X11_PINK, 590.0992,1243.8767,11.7188, 20.0);
}
...
hook OnVehicleDestroyed(vehicleid)
{
    ...
    if(jobs::mixer[playerid][mixerDuty][0] && jobs::mixer[playerid][mixerVehicle] == vehicleid)
    {
        for(new i = 0; i < 3; i++)
        {
            TextDrawHideForPlayer(playerid, jobs::GBMixer[i]);
    ...
    DestroyVehicle(vehicleid); // Hapus kendaraan yang meledak agar tidak respawn
    return 1;
}
