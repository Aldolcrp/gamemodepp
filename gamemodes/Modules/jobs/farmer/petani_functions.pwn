...
hook OnPlayerKeyStateChange(playerid, newkeys, oldkeys)
{
    if(newkeys & KEY_YES && GetPlayerState(playerid) == PLAYER_STATE_ONFOOT)
    {
        ...
        {
            ShowPlayerDialog(playerid, DIALOG_BUY_SEEDS, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay"WHITE" - Beli Bibit",
            "Jenis Bibit\tHarga\
            \nCabe\t"DARKGREEN"$7\
            \nTebu\t"DARKGREEN"$10\
        ...
        if(IsPlayerInDynamicArea(playerid, PlayerFarmerVars[playerid][FarmerOlahArea]))
        {
            ...
            {
                ShowPlayerDialog(playerid, DIALOG_FARMER_OLAH, DIALOG_STYLE_TABLIST_HEADERS, ""TTR"Astral City Roleplay "WHITE"- Olah Tanaman",
                "Item\tReqruitment\
    ...
    switch(dialogid)
    {
        case DIALOG_BUY_SEEDS:
        {
            ...
            switch(listitem)
            {
                case 0:// cabe
                {
                    ShowPlayerDialog(playerid, DIALOG_BIBIT_CABE, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Bibit Cabe", 
                ...
                case 1:// tebu
                {
                    ShowPlayerDialog(playerid, DIALOG_BIBIT_TEBU, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Bibit Tebu", 
                    ""WHITE"Anda akan membeli "YELLOW"bibit tebu"WHITE" seharga "DARKGREEN"$10/bibit\
                    \n"YELLOW"(Masukkan berapa banyak bibit yang ingin anda beli):", "Input", "Batal");
                }
                case 2:// padi
                {
                    ShowPlayerDialog(playerid, DIALOG_BIBIT_PADI, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Bibit Padi", 
        ...
        case DIALOG_BIBIT_CABE:
        {
            ...
            if(isnull(inputtext))
            {
                return ShowPlayerDialog(playerid, DIALOG_BIBIT_CABE, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Bibit Cabe", 
        ...
        case DIALOG_BIBIT_TEBU:
        {
            ...
            if(isnull(inputtext))
            {
                return ShowPlayerDialog(playerid, DIALOG_BIBIT_TEBU, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Bibit Tebu", 
        ...
        case DIALOG_BIBIT_PADI:
        {
            ...
            if(isnull(inputtext))
            {
                return ShowPlayerDialog(playerid, DIALOG_BIBIT_PADI, DIALOG_STYLE_INPUT, ""TTR"Astral City Roleplay "WHITE"- Bibit Padi", 
