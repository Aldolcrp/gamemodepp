    ...
    if(newstate == PLAYER_STATE_DRIVER)
    {
        ...
        if(IsSweeperVehicle(vehicleid))
        {
            if(!DurringSweeping[playerid])
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_SWEEPER_START, DIALOG_STYLE_MSGBOX, ""TTR"Astral City Roleplay "WHITE"- Sweeper Sidejob", "Apakah anda ingin memulai tugas sweeper?\
